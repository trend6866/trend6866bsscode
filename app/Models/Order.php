        ...
        if(!empty($order)) {
                ...
                foreach ($products as $key => $product) {
                    ...
                    if($order->payment_type == 'POS')
                    {
                        $products[$key] = [
                            ...
                            "per_product_discount_price" => SetNumber($product["per_product_discount_price"]),
                            "discount_price" => SetNumber($product["discount_price"]),
            ...
            if(!empty($OrderTaxDetail)) {
                foreach ($OrderTaxDetail as $tax_key => $value) {
                    ...
                    $order_array['tax'][$tax_key]['amountstring']  = SetNumber($value->tax_final_amount);
                }
            }
