...
class flutterwaveController extends Controller
{
    ...
    public function paymentConfig()
    {
        ...
        $this->secret_key = isset($payment_setting['flutterwave_secret']) ? $payment_setting['flutterwave_secret'] : '';
        $this->public_key = isset($payment_setting['public_key']) ? $payment_setting['public_key'] : '';
    ...
    public function flutterwavePost(Request $request)
    {
        // dd($request->all());
        ...
        // $res_data['email']       = \Auth::gust()->email;
    ...
    public function getProductStatus(Request $request,$slug)
    {
        ...
        $taxes = $cartlist['tax_info'];
            ...
            // dd($request->merge($requests_data));
