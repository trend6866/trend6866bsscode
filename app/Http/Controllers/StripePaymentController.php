...
class StripePaymentController extends Controller
{
    ...
    {
        // unset($data['_token'], $data['delivery_comment'], $data['payment_comment'], $data['sub_total'], $data['tax_info'], $data['product'], $data['shipping_id'], $data['price'], $data['cartlist_final_price']);
        ...
        $stripe_secret = \App\Models\Utility::GetValueByName('stripe_secret', $theme_id);
