...
class PayFastController extends Controller
{
        ...
        if (Auth::check()) {
            ...
            if ($plan) {
                ...
                $data = array(
                    ...
                    'return_url' => route('admin.payfast.payment.success', $success),
                    'cancel_url' => route('admin.plan.index'),
                    'notify_url' => route('admin.plan.index'),
                    // Buyer details
    ...
    public function success($success)
    {
        try {
            ...
            return redirect()->route('admin.plan.index')->with('error', __($e));
        }
    }

    public function payfastPayment($slug, $success, Request $request)
    {
