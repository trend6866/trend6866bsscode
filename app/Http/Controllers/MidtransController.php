...
class MidtransController extends Controller
{
    public function paywithMidtrans(Request $request)
    {
        ...
        try
        {
            ...
            $data = [
                ...
                'plan_id' => $plan->id,
                'amount' => $get_amount,
                'fallback_url' => 'admin.plan.get.midtrans.status'
            ];
    ...
    public function OrderPayWithMidtrans(Request $request)
    {
        ...
        try {
            ...
            $params = array(
                'transaction_details' => array(
                    'order_id' => $orderID,
                    'gross_amount' => $cartlist_final_price,
                ),
                'customer_details' => array(
            ...
            $data = [
                ...
                'fallback_url' => 'midtrans.callback'
            ];
            return view('midtras.payment', compact('data'));
        } catch (\Exception $e) {
