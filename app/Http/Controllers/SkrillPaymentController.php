...
class SkrillPaymentController extends Controller
{
    ...
    public function planPayWithSkrill(Request $request)
    {
        ...
        if($plan)
        {
            ...
            $skill->cancel_url   = route('admin.plan.skrill', [$request->plan_id]);
    ...
    public function getPaymentStatus(Request $request, $plan)
    {
        ...
        if($plan)
        {
            ...
            {
                return redirect()->route('admin.plan.index')->with('error', __('Plan not found!'));
            }
        }
        else
        {
    ...
    public function payWithSkrill( Request $request)
    {
        // $payment    = $this->paymentConfig();
        $payment = Utility::getAdminPaymentSetting();
