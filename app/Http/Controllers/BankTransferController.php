...
class BankTransferController extends Controller
{
    public function planPayWithbank(Request $request)
    {
        ...
        if ($order)
        {
            return redirect()->route('admin.plan.index')->with('error', __('You already send Payment request to this plan.'));
        }
        if ($request->payment_receipt)
        {
            ...
            if ($plan) {
                ...
                $order->save();
                // dd($order);
                return redirect()->route('admin.plan.index')->with('success', __('Plan payment request send successfully!'));
            }
        }
    }
