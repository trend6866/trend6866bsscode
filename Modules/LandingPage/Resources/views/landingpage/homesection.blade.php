            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div class="card">
                        ...
                        {{ Form::open(array('route' => 'admin.homesection.store', 'method'=>'post', 'enctype' => "multipart/form-data",'id' => 'imageUploadForm')) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-info" href="{{ $logo.'/'.$home_logo }}" download="" data-toggle="tooltip" data-original-title="Download">
