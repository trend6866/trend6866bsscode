                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <label class="form-check-label" for="customCheckc1">
                                                {{ $value->max_products != -1 ? $value->max_products . ' Products' : 'Unlimited' }}
                                                </label>
                                        </div>
                                    </li>
                                    {{-- <li>
                                    ...
                                    {{-- <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->shipping_method != 'off' ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->shipping_method =='on' ? 'Enable' : 'Disable' }} Shipping Method</label>
                                        </div>
                                    </li> --}}
                                    {{-- <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->additional_page != 'off' ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->blog != 'off' ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->blog =='on' ? 'Enable' : 'Disable' }} Blog</label>
                                        </div>
                                    </li> --}}
                                    <li>
                                        <div class="form-check text-start">
