                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ $totle_sales }} <span class="text-danger text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                        ...
                                        <div class="card-body stats">
                                            <div class="theme-avtar bg-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <mask id="mask0_724_629" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                                                    <path d="M0 0H20V20H0V0Z" fill="white"/>
                                                    </mask>
                                                    <g mask="url(#mask0_724_629)">
                                                    <path d="M19.2188 8.59375V4.6875C19.2188 2.53012 17.4699 0.78125 15.3125 0.78125H4.68752C2.53014 0.78125 0.781273 2.53012 0.781273 4.6875V15.3125C0.781273 17.4699 2.53014 19.2188 4.68752 19.2188H8.75002" stroke="#D80027" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M8.00781 4.297H11.9922" stroke="#D80027" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M19.2187 14.7266C19.2187 17.2075 17.2075 19.2188 14.7266 19.2188C12.2456 19.2188 10.2344 17.2075 10.2344 14.7266C10.2344 12.2456 12.2456 10.2344 14.7266 10.2344C17.2075 10.2344 19.2187 12.2456 19.2187 14.7266Z" stroke="#D80027" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M13.5547 15.8984L15.8984 13.5547" stroke="#D80027" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M15.8984 15.8984L13.5547 13.5547" stroke="#D80027" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </g>
                                                    </svg>
                                            </div>
                                            <h6 class="mt-4 mb-2">{{ __('Total Cancel Orders') }}</h6>
                                            <h3 class="mb-0">{{ $totle_cancel_order }} <span class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                        ...
                                        <div class="card-body stats">
                                            <div class="theme-avtar bg-blue">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="21" viewBox="0 0 26 21" fill="none">
                                                    <path d="M3.37502 3.37512H21.4251C21.677 3.37512 21.9186 3.47518 22.0968 3.65333C22.275 3.83149 22.375 4.07308 22.3751 4.32503L22.375 7.88403" stroke="#D80027" stroke-width="1.18937" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M22.375 15.0091L22.375 18.1001C22.375 19.1495 21.5244 20 20.475 20H2.9C1.85066 20 1 19.1495 1 18.1001V2.90003C1 1.85066 1.85066 1 2.9 1H22.85C23.8994 1 24.75 1.85066 24.75 2.90003V17.1869C24.75 17.7465 24.4338 18.2581 23.9333 18.5085" stroke="#D80027" stroke-width="1.18937" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M24.7501 8.59998L22.375 9.54999H17.625C17.3755 9.54999 17.1285 9.59915 16.8979 9.69463C16.6674 9.79012 16.458 9.92998 16.2815 10.1064C16.1051 10.2828 15.9651 10.4924 15.8697 10.7229C15.7742 10.9534 15.725 11.2005 15.725 11.45C15.725 11.9539 15.9252 12.4371 16.2815 12.7934C16.6379 13.1497 17.1211 13.3499 17.625 13.3499H22.375L24.7501 12.3999" stroke="#D80027" stroke-width="1.18937" stroke-linejoin="round"/>
                                                    <path d="M18.1 11.4502C18.1 11.5762 18.05 11.697 17.9609 11.7861C17.8718 11.8752 17.751 11.9251 17.625 11.9251C17.499 11.9251 17.3782 11.8752 17.2892 11.7861C17.2001 11.697 17.15 11.5762 17.15 11.4502C17.15 11.3243 17.2001 11.2033 17.2892 11.1143C17.3782 11.0252 17.499 10.9752 17.625 10.9752C17.751 10.9752 17.8718 11.0252 17.9609 11.1143C18.05 11.2033 18.1 11.3243 18.1 11.4502Z" fill="#D80027"/>
                                                </svg>
                                            </div>
                                            <h6 class="mt-4 mb-2">{{ __('Total Refund Orders') }}</h6>
                                            <h3 class="mb-0">{{ $total_refund_requests }} <span
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ SetNumberFormat($total_revenues) }} <span
                                                    class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="card-body stats welcome-card">
                                                    <div class="row align-items-center">
                                                        <div class="col-xxl-12">
                                                            ...
                                                            <h4 class="f-w-400">
                                                                <a href="{{ asset(!empty(Auth::guard('admin')->user()->profile_image) ? get_file(Auth::guard('admin')->user()->profile_image, APP_THEME()) : asset(Storage::url('uploads/profile/avatar.png'))) }}"
                                                                    target="_blank">
                                                                    <img src="{{ asset(!empty(Auth::guard('admin')->user()->profile_image) ? get_file(Auth::guard('admin')->user()->profile_image, APP_THEME()) : asset(Storage::url('uploads/profile/avatar.png'))) }}"
                                                                        alt="user-image" class="wid-35 me-2 img-thumbnail rounded-circle">
                                                                </a>
                                                                {{ __(Auth::guard('admin')->user()->name) }}
                                                            </h4>
                                                            ...
                                                            <div class="dropdown quick-add-btn">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a href="#" data-size="lg"
                                                                        data-url="{{ route('admin.product.create') }}"
                                                                        data-ajax-popup="true" data-title="{{ __('Add Product') }}"
                                                                        class="dropdown-item"
                                                                        data-bs-placement="top "><span>{{ __('Add new product') }}</span></a>

                                                                    <a href="#" data-size="md"
                                                                        data-url="{{ route('admin.tax.create') }}" data-ajax-popup="true"
                                                                        data-title="{{ __('Create Tax') }}" class="dropdown-item"
                                                                    ...
                                                                    <a href="#" data-size="md"
                                                                        data-url="{{ route('admin.coupon.create') }}"
                ...
                <div class="col-xxl-7 mb-4">
                    <div class="card min-h-390 overflow-auto card-dash">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="{{ route('admin.product.index') }}">{{ __('View All') }}</a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-7 mb-4">
                    <div class="card min-h-390 overflow-auto card-dash">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-primary" href="{{ route('admin.reports.index') }}">{{ __('View All') }}</a>
                        </div>
                        <div class="card-body">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a class="btn btn-primary" href="{{ route('admin.order.index') }}">{{ __('View All') }}</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                                    ...
                                    @foreach ($new_orders as $order)
                                        @if ($order->status != 'Cancel Order')
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="{{ route('admin.order.view', \Illuminate\Support\Facades\Crypt::encrypt($order->id)) }}"
                                                            {{-- @php
                                                                $btn_class = 'bg-info';
...
$btn_class = 'bg-info';
                                                            ...
                                                            data-toggle="tooltip" title="{{ _('Invoice ID') }}">
                                                ...
                                                <td>
                                                    <h6 class="m-0">
                                                        {{ SetNumberFormat($order->final_price) }}
                                                        <h6>
                                                </td>
                                                <td class="">
                                                    <h6 class="m-0">
    ...
    <script>
        ...
        (function() {
            var options = {
                ...
                series: [{
                    name: 'New Customer',
                    data: {!! json_encode($chartData['registerTotal']) !!}
                }, {
                    name: 'New Guest',
