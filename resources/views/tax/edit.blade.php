{{Form::model($tax, array('route' => array('admin.tax.update', $tax->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
<div class="row">
    ...
    <div class="form-group  col-md-6">
        ...
        {!! Form::select('tax_type', ['percentage' => 'Percentage', 'flat' => 'Flat'], null, ['class' => 'form-control']) !!}
    </div>
    <div class="form-group col-md-6">
