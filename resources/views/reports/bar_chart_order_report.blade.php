...
@section('action-button')
    <div class="text-end">
        ...
        <a href="{{ route('admin.reports.order_report') }}" class="btn btn-sm btn-primary btn-icon"
    ...
    <script>
        $(document).ready(function() {
            function fetchData(value, date) {
                ...
                $.ajax({
                    type: "GET",
                    url: '{{ route('admin.reports.order.chart.data') }}',
                    async: true,
                    data: {
                        _token: csrfToken,
                        chart_data: value,
    ...
    <script>
        $(document).ready(function() {
            $('.exportChartButton').click(function() {
                $.ajax({
                    url: '{{ route('admin.order.barchart.reports.export') }}',
                    method: 'GET',
                    success: function(data) {
