...
@section('action-button')
    <div class="text-end">
        ...
        <a href="{{ route('admin.orders.barchart_order_report') }}" class="btn btn-sm btn-primary btn-icon" title="{{ __('Radial Bar Chart') }}"
            data-bs-toggle="tooltip" data-bs-placement="top">
    ...
    <script>
        $(document).ready(function() {
            function fetchData(value, date) {
                ...
                $.ajax({
                    type: "GET",
                    url: '{{ route('admin.reports.order.chart') }}',
                    async: true,
                    data: {
                        _token: csrfToken,
                        chart_data: value,
    ...
    <script>
        $(document).ready(function() {
            $('.exportChartButton').click(function() {
                $.ajax({
                    url: '{{ route('admin.order.reports.export') }}',
                    method: 'GET',
                    success: function(data) {
