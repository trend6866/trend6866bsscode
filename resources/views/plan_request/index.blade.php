                            ...
                            <tbody>
                                @foreach($plan_requests as $prequest)
                                    <tr>
                                        ...
                                        <td>{{ \App\Models\Utility::dateFormat($prequest->created_at,true) }}</td>
                                        
                                        
                                        
                                        <td class="text-end">
                                            <div>
                                                <a href="{{route('admin.response.request',[$prequest->id,1])}}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-check"></i>
                                                </a>
                                                <a href="{{route('admin.response.request',[$prequest->id,0])}}" class="btn btn-danger btn-sm">
