                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-primary me-2"
                                                data-url="{{ route('admin.flash-sale.edit', $flashsale->id) }}" data-size="lg"
                                                data-ajax-popup="true" data-title="{{ __('Edit Flash Sale') }}">
                                                <i class="ti ti-pencil py-1" data-bs-toggle="tooltip" title="edit"></i>
                                            </button>
                                            @endcan
                                            @can('Delete Flashsale')
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['admin.flash-sale.destroy',$flashsale->id], 'class' => 'd-inline']) !!}
    ...
    <script>
        $(document).ready(function () {
            $('.flashsale-toggle').on('change', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.update-flashsale-status') }}',
                    data: {
