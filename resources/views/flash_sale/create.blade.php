    {{ Form::open(['route' => 'admin.flash-sale.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'repeater']) }}
    <div class="row">
        ...
        {{-- <div class="form-group col-md-12">
            {!! Form::label('', __('Sale Enable'), ['class' => 'form-label']) !!}
            <div class="form-check form-switch">
                <input type="hidden" name="sale_enable" value="0">
                {!! Form::checkbox('sale_enable', 1, 1, [
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.message == 'campaign for shop') {
                        ...
                        // var optionValue = $(this).closest('.form-group-container').find('.option')
                        //     .val();

                        // Update the "option" field in the current array
                        // $("select[name='fields[" + index + "][option]']").val(optionValue);
