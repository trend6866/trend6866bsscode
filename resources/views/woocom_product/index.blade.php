                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        @if (in_array($data->id,$upddata))
                                            @can('Edit Woocommerce Product')    
                                            <a href="{{ route('admin.woocom_product.edit', $data->id) }}"  class="btn btn-sm btn-info"
                                                data-title="{{ __('Sync Again') }}" >
                                                <i class="ti ti-refresh " data-bs-toggle="tooltip" title="Sync Again"></i>
                                            </a>
                                            @endcan
                                        @else
                                            @can('Create Woocommerce Product')
                                            <a href="{{ route('admin.woocom_product.show', $data->id) }}" class="btn btn-sm btn-primary"
