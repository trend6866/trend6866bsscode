...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"> {{ $User_data->first_name }} </li>
@endsection
...
@section('content')
    <div class="row  custom-timeline-2 ">
                ...
                <div class="col-lg-3 col-6">
                    <div class="card stats-wrapper info-card">
                        <div class="card-body stats">
                            ...
                            <h3 class="mb-0">{{ $User_data->email }}<span class="text-success text-sm">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
        ...
        @if (!empty($User_data->regiester_date))
        ...
        <div class="text-center pt-5">
            <h2>{{ __('User') }} {{ $User_data->first_name }} {{ __('has not registered.') }}</h2>
        </div>
        @endif
    </div>
@endsection
