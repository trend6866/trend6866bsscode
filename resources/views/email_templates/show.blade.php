        ...
        <li class="dropdown dash-h-item drp-language ">
            ...
            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                ...
                @foreach ($languages as $key => $lang)
                    <a href="{{ route('admin.manage.email.language', [$emailTemplate->id, $key]) }}"
                        class="dropdown-item {{ $currEmailTempLang->lang == $key ? 'text-primary' : '' }}">{{ Str::upper($lang) }}</a>
                @endforeach
            </div>
        </li>
    </ul>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body ">
                    {{-- <div class="card"> --}}
                        {{ Form::model($currEmailTempLang, ['route' => ['admin.updateEmail.settings', $currEmailTempLang->parent_id], 'method' => 'PUT']) }}
                    <div class="row">
