...
<div class="text-end d-flex all-button-box justify-content-md-end justify-content-center">
    <a href="{{ route('admin.addon.create') }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="checkbox-custom">
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                        ...
                                        <form action="{{ route('admin.theme.enable') }}" method="POST" id="form_{{ $value->theme_id }}">
                                            @csrf
                                            <input type="hidden"
                                                name="name" value="{{ $value->theme_id }}">
                                        </form>

                                        {!! Form::open(['method' => 'DELETE', 'route' => ['admin.addon.destroy', $value->theme_id], 'class' => 'd-inline']) !!}
