                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                @if ( in_array($data['id'],$upddata))
                                    @can('Edit Woocommerce Coupon')
                                    <a href="{{ route('admin.shopify_coupon.edit', $data['id']) }}"  class="btn btn-sm btn-primary"
                                        data-title="{{ __('Sync Again') }}" >
                                        <i class="ti ti-refresh " data-bs-toggle="tooltip" title="Sync Again"></i>
                                    </a>
                                    @endcan
                                @else
                                    @can('Create Woocommerce Coupon')
                                    <a href="{{ route('admin.shopify_coupon.show', $data['id']) }}" class="btn btn-sm btn-primary"
