                                ...
                                @foreach ($customers['customers'] as $data)
                                    ...
                                    <tr class="font-style">
                                        ...
                                        @if ( in_array($data['email'],$upddata))
                                            ...
                                            <a href="{{ route('admin.shopify_customer.edit', $data['id']) }}"  class="btn btn-sm btn-primary"
                                        ...
                                        @else
                                            ...
                                            <a href="{{ route('admin.shopify_customer.show', $data['id']) }}" class="btn btn-sm btn-primary"
