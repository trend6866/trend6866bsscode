                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                @if ( in_array($cat_data['id'],$upddata))
                                                    ...
                                                    <a href="{{ route('admin.shopify_category.edit', $cat_data['id']) }}"  class="btn btn-sm btn-info"
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{ route('admin.shopify_category.show', $cat_data['id']) }}" class="btn btn-sm btn-primary"
