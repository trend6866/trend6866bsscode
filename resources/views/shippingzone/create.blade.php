{{ Form::open(['route' => 'admin.shippingZone.store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
@php
...
<div class="row">
    ...
    <div class="form-group list_height_css col-md-12">
        ...
        <div class="state">
        {!! Form::select('state_id', [], null, ["class"=>"form-control state_name state_chage", "placeholder"=>"Select State", "required"=>true, 'data-select' => 0]) !!}
        </div>
    </div>
    <div class="form-group col-md-12">
