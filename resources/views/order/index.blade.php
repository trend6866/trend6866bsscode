...
<div class="text-end">
    <a class="btn btn-sm btn-primary btn-icon " href="{{ route('admin.order.export') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Export') }}">
                                ...
                                <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('admin.order.view', \Illuminate\Support\Facades\Crypt::encrypt($item->id)) }}"
                                                    @php
                                                        $btn_class = 'bg-info';
                                        ...
                                        <td>{{ SetNumberFormat($item->final_price) }}</td>
                                        <td>
                                        ...
                                        <td>{{ !empty($item->DeliveryBoy) ? $item->DeliveryBoy->name : '-' }}</td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            @can('Show Orders')
                                                <a href="javascript:void(0)" data-url="{{ route('admin.order.order_view', \Illuminate\Support\Facades\Crypt::encrypt($item->id)) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Order')}}    #{{ $item->product_order_id }}" class="x-3 btn btn-sm align-items-center btn btn-sm btn-info me-2" data-bs-toggle="tooltip" data-original-title="{{__('Show')}}">
                                            ...
                                            @can('Delete Orders')
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['admin.order.destroy', $item->id], 'class' => 'd-inline']) !!}
...
@push('custom-script')
    <script>
        ...
        $(document).on('click', '.return_request', function() {
            ...
            $.ajax({
                url: '{{ route('admin.order.return.request') }}',
                method: 'POST',
                data: data,
                context:this,
