...
<div class="modal-footer pr-0">
    <a href="{{ route('admin.order.approve', [$order->id]) }}" class="btn btn-success">{{ __('Approval') }}</a>
    <a href="{{ route('admin.order.reject', [$order->id]) }}"  class="btn btn-danger" >{{ __('Reject') }}</a>
</div>