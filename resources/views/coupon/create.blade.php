{{ Form::open(['route' => 'admin.coupon.store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
...
@if ($plan->enable_chatgpt == 'on')
    <div class="d-flex justify-content-end mb-1">
        <a href="#" class="btn btn-primary me-2 ai-btn" data-size="lg" data-ajax-popup-over="true"
            data-url="{{ route('admin.generate', ['coupan']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
