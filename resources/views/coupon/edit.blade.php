{{Form::model($coupon, array('route' => array('admin.coupon.update', $coupon->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
...
<div class="d-flex justify-content-end mb-1">
    <a href="#" class="btn btn-primary me-2 ai-btn" data-size="lg" data-ajax-popup-over="true" data-url="{{ route('admin.generate',['coupan']) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate') }}" data-title="{{ __('Generate Content With AI') }}">
