@extends('layouts.app')
@section('page-title', __('Attribute'))
...
<div class=" text-end d-flex all-button-box justify-content-md-end justify-content-center">
    <a href="#" class="btn btn-sm btn-primary add_attribute" data-ajax-popup="true" data-size="md"
        ...
        data-url="{{ route('admin.product-attribute.create') }}"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="text-success f-w-600" href="{{ route('admin.product-attribute-option.show',[$productAttribute->id]) }}">{{__('Configure terms')}}</a>
                            </td>


                            <td class="text-end">
                                <button class="btn btn-sm btn-primary me-2"
                                    data-url="{{ route('admin.product-attribute.edit', $productAttribute->id) }}"
                                    data-size="md" data-ajax-popup="true"
                                    data-title="{{ __('Edit Attribute') }}" >
                                    <i class="ti ti-pencil py-1" data-bs-toggle="tooltip" title="edit"></i>
                                </button>

                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.product-attribute.destroy', $productAttribute->id], 'class' => 'd-inline']) !!}
