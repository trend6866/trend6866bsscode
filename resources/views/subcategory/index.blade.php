...
@can('Create Product Sub Category')
<div class=" text-end d-flex all-button-box justify-content-md-end justify-content-center">
    <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
        data-title="Add Sub category"
        data-url="{{ route('admin.sub-category.create') }}"
                ...
                <table class="table dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                @can('Edit Product Sub Category')
                                <button class="btn btn-sm btn-primary me-2"
                                    data-url="{{ route('admin.sub-category.edit', $Category->id) }}"
                                ...
                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.sub-category.destroy', $Category->id], 'class' => 'd-inline']) !!}
