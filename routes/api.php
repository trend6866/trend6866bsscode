...
Route::post('{slug}/fargot-password-send-otp', [AuthController::class, 'fargot_password_send_otp'])->middleware(['APILog']);
Route::post('{slug}/fargot-password-verify-otp', [AuthController::class, 'fargot_password_verify_otp'])->middleware(['APILog']);
Route::post('{slug}/fargot-password-save', [AuthController::class, 'fargot_password_save'])->middleware(['APILog']);
...
Route::post('{slug}/search', [ApiController::class, 'search'])->middleware(['auth:sanctum', 'APILog']);
...
Route::post('{slug}/categorys-product', [ApiController::class, 'categorys_product'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/categorys-product-guest', [ApiController::class, 'categorys_product_guest'])->middleware(['APILog']);
Route::post('{slug}/product-detail', [ApiController::class, 'product_detail'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/product-detail-guest', [ApiController::class, 'product_detail_guest'])->middleware(['APILog']);
Route::post('{slug}/product-rating', [ApiController::class, 'product_rating'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/random_review', [ApiController::class, 'random_review'])->middleware(['APILog']);
Route::post('{slug}/addtocart', [ApiController::class, 'addtocart'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/cart-qty', [ApiController::class, 'cart_qty'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/cart-list', [ApiController::class, 'cart_list'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/cart-check', [ApiController::class, 'cart_check'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/cart-check-guest', [ApiController::class, 'cart_check_guest'])->middleware(['APILog']);
Route::post('{slug}/wishlist', [ApiController::class, 'wishlist'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/wishlist-list', [ApiController::class, 'wishlist_list'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/bestseller', [ApiController::class, 'bestseller'])->middleware(['auth:sanctum', 'APILog']);
...
Route::post('{slug}/tranding-category-product', [ApiController::class, 'tranding_category_product'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/tranding-category-product-guest', [ApiController::class, 'tranding_category_product_guest'])->middleware(['APILog']);
Route::post('{slug}/home-categoty', [ApiController::class, 'home_categoty'])->middleware(['APILog']); // Main category
Route::post('{slug}/sub-categoty', [ApiController::class, 'sub_categoty'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/sub-categoty-guest', [ApiController::class, 'sub_categoty_guest'])->middleware(['APILog']);
...
Route::post('{slug}/confirm-order', [ApiController::class, 'confirm_order'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/place-order', [ApiController::class, 'place_order'])->name('place-order')->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/place-order-guest', [ApiController::class, 'place_order_guest'])->middleware(['APILog']);
Route::post('{slug}/order-list', [ApiController::class, 'order_list'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/return-order-list', [ApiController::class, 'return_order_list'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/order-detail', [ApiController::class, 'order_detail'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/order-status-change', [ApiController::class, 'order_status_change'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/product-return', [ApiController::class, 'product_return'])->middleware(['auth:sanctum', 'APILog']);
...
Route::post('{slug}/recent-product', [ApiController::class, 'recent_product'])->middleware(['auth:sanctum', 'APILog']);
Route::post('{slug}/recent-product-guest', [ApiController::class, 'recent_product'])->middleware(['APILog']);
Route::post('{slug}/releted-product', [ApiController::class, 'releted_product'])->middleware(['auth:sanctum', 'APILog']);
...
Route::prefix('admin')->as('admin.')->group(function(){
    ...
    Route::get('currency', [DashboardController::class, 'currency'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::post('dashboard', [DashboardController::class, 'dashboard'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('categorylist', [DashboardController::class, 'CategoryList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('productlist', [DashboardController::class, 'ProductList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('variantlist', [DashboardController::class, 'VariantList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('orderlist', [DashboardController::class, 'OrderList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('couponlist', [DashboardController::class, 'CouponList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('shippinglist', [DashboardController::class, 'ShippingList'])->middleware(['auth:sanctum','AdminApiLog']);
    Route::get('taxlist', [DashboardController::class, 'TaxList'])->middleware(['auth:sanctum','AdminApiLog']);
