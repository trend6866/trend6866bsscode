                ...
                <div class="product-card-inner">
                    <div class="card-top">
                        @php
                            ...
                            @foreach ($latestSales as $productId => $saleData)
                                <span style="border: 1px solid var(--white);">
                            ...
                            @endforeach
                        <a href="javascript:void(0)" class="wishlist-btn wishbtn-globaly " product_id="{{ $data->id }}" in_wishlist="{{ $data->in_whishlist ? 'remove' : 'add'}}">
                                {{ __('Add to wishlist') }}
                                <span class="wish-ic">
                    ...
                    <div class="card-bottom">
                        ...
                        <div class="card-btn-wrapper">
                            ...
                            @endif
                            <a href="javascript:void(0)" class="btn  addtocart-btn-cart addcart-btn-globaly" product_id="{{ $data->id }}" variant_id="0" qty="1">
                                {{__('ADD TO CART')}}
