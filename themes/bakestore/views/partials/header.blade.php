                        ...
                        <li class="menu-lnk has-item">
                            ...
                            @else
                                <div class="menu-dropdown">
                                    <ul>
                                        @foreach ($MainCategoryList as $category)
                                            <li><a href="{{ route('page.product-list', [$slug,'main_category' => $category->id]) }}">{{ $category->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                    ...
                    <ul class="menu-right d-flex  justify-content-end align-items-center">
                        ...
                        <li class="cart-header">
                            <a href="javascript:;">
                                ...
                                <svg class="bottom-icons-header" xmlns="http://www.w3.org/2000/svg" width="17"
    ...
    <div class="mobile-menu-wrapper">
        ...
        <div class="mobile-menu-bar">
            <ul>
                ...
                <li class="mobile-item">
                    <a href="{{route('page.faq',$slug)}}">{{ __('FAQs')}}</a>
                </li>
                <li class="mobile-item">
