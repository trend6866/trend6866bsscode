                ...
                <div class="footer-widget footer-ween">
                    ...
                    <ul>
                        @for($i=0 ; $i < $homepage_footer_section3['loop_number'];$i++)
                            ...
                            @endphp
                            <li><a href="{{asset($homepage_footer_section3_link)}}">{!! $homepage_footer_section3_sub_title!!}</a></li>
                        @endfor
                    </ul>
                    @endif
                </div>
            ...
            <div class="footer-col footer-link footer-link-2">
                ...
                <ul>
                    @for($i=0 ; $i < $homepage_footer_section5['loop_number'];$i++)
                        ...
                        @endphp
                        <li><a href="{{asset($homepage_footer_section5_link)}}">{!! $homepage_footer_section5_sub_title!!}</a></li>
                    @endfor
