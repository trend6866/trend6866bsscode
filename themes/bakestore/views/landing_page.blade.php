...
@section('content')
    <div class="main-top">
            ...
            if ($homepage_header_1_key != '') {
                ...
                foreach ($homepage_header_1['inner-list'] as $key => $value) {
                    ...
                    if ($value['field_slug'] == 'homepage-banner-img') {
                        $chocolate_img = $value['field_default_text'];
                    }
                }
            }
        @endphp
        ...
        <section class="second-sec padding-top padding-bottom">
            ...
            <img src="{{ get_file($chocolate_img, APP_THEME()) }}" class="bakery-1" alt="image">
            <div class=" container">
                    ...
                    <div class="col-lg-6 col-12  d-flex">
                        <div class="card-right-side w-100">
                            <div class="right-card-slider w-100">
                                {!! \App\Models\MainCategory::HomePageCategory($slug, 10) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="left-col">
                            <div class="section-title">
                                ...
                                @endphp
                                @if ($homepage_header_1['section_enable'] == 'on')
                                    <h2>{!! $homepage_category_title_text !!}</b></h4>
                            </div>
                            <p>{!! $homepage_category_sub_text !!}</p>
                            <div class="btn-wrapper">
                                <a href="{{ route('page.product-list', $slug) }}" class="btn-secondary">
