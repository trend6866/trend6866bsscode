...
<head>
    ...
    <title>
        {{ \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : 'Chocolate' }}
...
<body @if (in_array(\Request::route()->getName(), ['landing_page']))class="home-bg" @elseif(in_array(\Request::route()->getName(), ['page.product'])) class="product-bg" @elseif (in_array(\Request::route()->getName(), ['my-account'])) class="my-acc-body"@endif>
