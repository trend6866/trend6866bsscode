...
<head>
    ...
    <title>
        {{ \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : ' Mountain' }}
    ...
    <link rel="shortcut icon" href="{{ asset('themes/' . APP_THEME() . '/assets/img/favicon.png') }}">
