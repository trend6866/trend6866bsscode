                        ...
                        <div class="product-sorting-row d-flex align-items-center justify-content-between">
                            ...
                            <div class="filter-select-box d-flex align-items-center justify-content-end">
                                ...
                                <select class="filter_product">
                                    ...
                                    <option value="trending" {{ !empty($filter_product) && $filter_product == 'trending' ? 'selected="selected"' : '' }}>
                                        {{ __('Trending Product') }}
                                    </option>
                                    ...
                                    <div class="about-subtitle">
                                        ...
                                        <div class="card-title">
                                            <div class="card-add-to-list long_sting_to_dot">
                                                <h3>
                                                    <a href="{{route('page.product',[$slug,$p_id])}}">{{ $data->name }} <br/>{{ $data->default_variant_name }}</a>
                                                </h3>
                                            ...
                                            <div class="product-card-itm-datail">
                                                @if ($data->variant_product == 0)
                                                    <div class="price">
                                                        <ins>{{ $currency_icon }} {{ $data->final_price }}</ins>
                                                    </div>
                                                @else
                                                    <div class="price">
                                                ...
                                                @endif
                                                <a href="javascript:void(0)" class="btn btn-secondary addcart-btn-globaly" product_id="{{ $data->id }}" variant_id="0" qty="1">
                                                    {{ __('Add to cart') }}
