...
$(document).ready(function() {
    ...
    var backButton = '<div class="slick-prev left"><img src="assets/images/arrow.png"></div>';
    var nextButton = '<div class="slick-next right"><img src="assets/images/right-arr.png"></div>'
    ...
    var backButtonSec = '<div class="slick-prev1 second-left"><img src="assets/images/arrow.png"></div>';
    var nextButtonSec = '<div class="slick-next1 second-right"><img src="assets/images/right-arr.png"></div>'
    if($('.home-categorey-slider').length > 0 ){
        $('.home-categorey-slider').slick({
            autoplay: false,
            slidesToShow: 3,
            speed: 1000,
            slidesToScroll: 3,
    ...
    if($('.img-product-card-slider').length > 0 ){
        $('.img-product-card-slider').slick({
            autoplay: false,
            slidesToShow: 4,
            speed: 1000,
            slidesToScroll: 4,
    ...
    if($('.testimonials-card-slider').length > 0 ){
        $('.testimonials-card-slider').slick({
            autoplay: false,
            slidesToShow: 1,
            speed: 1000,
            slidesToScroll: 1,
    ...
    var backButtonSec = '<div class="slick-prev1 third-left"><img src="assets/images/arrow.png"></div>';
    var nextButtonSec = '<div class="slick-next1 third-right"><img src="assets/images/right-arr.png"></div>'
    if($('.bestseller-card-slider').length > 0 ){
        $('.bestseller-card-slider  ').slick({
            autoplay: false,
            slidesToShow: 3,
            speed: 1000,
            slidesToScroll: 3,
            dots: false,
            arrows: true,
            prevArrow: $('.third-left'),
            nextArrow: $('.third-right'),
            responsive: [
                {
                breakpoint:992,
                    settings: {
  ...
  // ARTICLE PAGE SLIDER JS
    if($('.article-blog-card-slider').length > 0 ){
        $('.article-blog-card-slider').slick({
            autoplay: false,
            slidesToShow: 4,
            speed: 1000,
            slidesToScroll: 1,
