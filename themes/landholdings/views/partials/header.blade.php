         ...
         <div class="top-header">
             ...
             <div class="right-side-header">
                 ...
                 <div class="store-info-wrapper">
                     ...
                     <div class="store-info-block">
                         <a href="tel:+12 002-224-111"><span class="label">{{ $header_text }}</span>
                             <b>{{ $header_contact }}</b></a>
                     </div>
                 </div>
                 <div class="header-info-end">
                     <ul class="menu-right d-flex align-items-center justify-content-end">
                         @guest
                             <li class="profile-header">
                                 <a href="{{ route('login', $slug) }}">
                                     ...
                                     <span class="icon-lable">My profile</span>
                                 </a>
                             </li>
                         @endguest
                         @auth
                         ...
                         <li class="cart-header">
                             <a href="javascript:;">
                                 <span class="icon-lable">{{ __('My Cart:') }} <b
                                         id="sub_total_main_page">{{ 0 }} {{ $currency }}</b></span>
