            ...
            <div class="col-xxl-7">
                                    ...
                                    @foreach ($order['product'] as $id => $item)
                                        ...
                                        <tr id="product-id-{{ $id }}">
                                            ...
                                            <input type="hidden" class="product_refund_price" name="return_price[]"
                                                value="@if ($order['paymnet_type'] == 'POS') {{ SetNumberFormat($item['orignal_price']) }} @else {{ SetNumberFormat($item['final_price']) }} @endif">
                                            @if (!$show_status)
                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <p class="mb-0"><b>{{ _('Order Refund Reason') }}</b></p>
                            ...
                            <div class="card-header d-flex justify-content-between OtherReason">
                                <p class="mb-0"><b>{{ _('Add Your Reason') }}</b></p>
                    ...
                    @foreach ($RefundStatus as $key => $status)
                        @if ($status->name == 'Attachment' && $status->is_active == '1')
                            <div class="col-xxl-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between">
                                        <p class="mb-0">
                                            <b>{{ _('Attachments') }}</b>:<small>({{ __('You can select multiple files') }})</small>
                                        </p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product_price_1 CURRENCY">
                                            @if (!$show_status)
                                                <span class="">{{ SetNumberFormat($order['sub_total']) }}</span>
                                            @else
                                                {{ SetNumberFormat($order_refunds->product_refund_price) }}
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="grand_total CURRENCY">
                                            @if (!$show_status)
                                                <b>{{ SetNumberFormat($order['final_price']) }}</b>
                                            @else
                                                <b>{{ SetNumberFormat($final_price) }}</b>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
