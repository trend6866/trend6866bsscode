...
<head>
    ...
    <title>@yield('page-title') -
        {{ \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : ' Jewellery' }}
    </title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&family=Playfair+Display:wght@400;500;600;700&display=swap"
        rel="stylesheet">
...
{{-- @if (route('page.product-list', $slug))
        <body class="shop">
    @else
        <body>
    @endif --}}
...
<body
    @if (in_array(\Request::route()->getName(), ['page.product-list'])) class="shop home-page"
    @elseif (\Request::route()->getName() == 'page.product') class="shop home-page"
    @else @endif>

    @include('partials.header')

    <!-- [ Main Content ] start -->
    <div class="wrapper" style="margin-top: 130.188px;">
