                ...
                <tr>
                    <td data-label="Product">
                        <a href="{{route('page.product',[$slug,$p_id])}}">
                            <img src="{{asset(get_file($wishlist->ProductData->cover_image_path, APP_THEME()))}}">
                        </a>
                    </td>
                    <td data-label="Name">
...
<div class="form-container">
    <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
        ...
        @endphp
        <button class="btn-secondary back-btn-acc" onclick="get_wishlists('{{ $previousPageUrl }}')">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14" viewBox="0 0 35 14" fill="none">
                <path d="M25.0749 14L35 7L25.0805 0L29.12 6.06667H0V7.93333H29.12L25.0749 14Z"></path>
            </svg>
            {{ __('Back') }}
        </button>
        <button class="btn continue-btn" onclick="get_wishlists('{{ $nextPageUrl }}')">
            {{ __('Next') }}
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14" viewBox="0 0 35 14" fill="none">
                <path d="M25.0749 14L35 7L25.0805 0L29.12 6.06667H0V7.93333H29.12L25.0749 14Z"></path>
            </svg>
