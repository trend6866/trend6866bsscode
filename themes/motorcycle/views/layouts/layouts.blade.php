@php
    ...
    $store = \App\Models\Store::where('slug', $slug)
        ->where('is_active', '1')
        ->first();
    $title = \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : 'motorbike';
...
<head>
    ...
    <meta name="author" content="motorbikes and accessories">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <title>@yield('page-title') - {{ $title }} </title>
    <meta name="base-url" content="{{ URL::to('/') }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="motorbikes and accessories.">
    <meta name="keywords" content="motorbikes and accessories.">
    ...
    <link rel="shortcut icon"
        href="{{ isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicon : asset('themes/' . APP_THEME() . '/assets/images/favicon.png') }}">
    <link
