...
@section('content')
    ...
    <div class="wrapper home-wrapper">
                            ...
                            <div class="banner-content">
                                <div class="container">
                                    <div class="banner-content-inner comman-title-white">
                                        <h2 class="h1">{!! $homepage_banner_title !!}</h2>
                                ...
                                <div class="best-selling-card-inner">
                                    <div class="best-card-image">
                                        ...
                                        <div class="best-card-btn">
                                            <a href="{{ route('page.product-list', [$slug, 'main_category' => $cat->id]) }}"
                                                class="btn-secondary white-btn" style="color: black">
                                                {{ __('Go to categories') }}
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card-inner">
                                <div class="product-content-top text-center">
                                    <div class="label">
                                        {{ !empty($data->ProductData()) ? $data->ProductData()->name : '' }}</div>
        ...
        <section class="two-col-slider-section">
            <div class="container">
                @php
                                ...
                                <div class="product-card">
                                    <div class="product-card-inner">
                                        <div class="product-content-top text-center">
                                            ...
                                            <h3><a href="{{ route('page.product', [$slug, $p_id]) }}">{{ $product->name }}</a>
                                            </h3>
    ...
    <section class="best-seller-section padding-top padding-bottom">
        <div class="container">
                ...
                @foreach ($all_products as $items)
                    <div class="product-card ">
                        @php
                            ...
                            $wishlist = App\Models\Wishlist::where('product_id', $items->id)
                        ...
                        <div class="product-card-inner">
                            <div class="product-content-top text-center">
                                ...
                                <h3><a href="{{ route('page.product', [$slug, $p_id]) }}">{{ $items->name }}</a> </h3>
                                    <div class="favorite-icon">
                                        <a href="javascript:void(0)" class="wishbtn-globaly "
                                            product_id="{{ $items->id }}"
                            ...
                            <div class="product-img">
                                <a href="{{ route('page.product', [$slug, $p_id]) }}">
                                    <img src="{{ get_file($items->cover_image_path, APP_THEME()) }}">
                                </a>
                            </div>
                            <div class="product-content-bottom text-center">
                                ...
                                @endforeach
                                <a href="javascript:void(0)" class="btn theme-btn addcart-btn-globaly"
                                    product_id="{{ $items->id }}" variant_id="0"
                                    qty="1">
                                    {{ __('Add to cart') }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15"
                                        viewBox="0 0 16 15" fill="none">
    ...
    <section class="custom-banner-section-two">
    ...
    <section class="two-col-slider-two-section">
        <div class="container">
            @php
                    ...
                    <div class="product-card ">
                        <div class="product-card-inner">
                            <div class="product-content-top text-center">
                                ...
                                <h3><a href="{{ route('page.product', [$slug, $p_id]) }}">{{ $new_product->name }}</a>
                                </h3>
                                    <div class="favorite-icon">
                                        <a href="javascript:void(0)" class="wishbtn-globaly"
                        ...
                        <div class="testimonial-inner card-inner">
                            ...
                            <div class="testimonial-right">
                                ...
                                <div class="bottom-content">
                                    ...
                                    <p>{{ !empty($review->UserData()) ? $review->UserData->first_name : '' }}, Client</p>
                                </div>
                            </div>
                        </div>
                    </div>
