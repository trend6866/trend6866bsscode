@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Fashion';
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <meta name="author" content="Cosmetics & Hospitals - Workdo.">
        ...
        {{-- <meta name="description" content="Cosmetics & Hospitals - Workdo.">
        <meta name="keywords" content="Cosmetics & Hospitals - Workdo."> --}}
        ...
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Balsamiq+Sans:ital,wght@0,400;0,700;1,400;1,700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
            rel="stylesheet">
    ...
    <body @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home" @else
        @endif>
        @include('partials.header')

        <!-- [ Main Content ] start -->
        @if(\Route::current()->getName() != 'landing_page')
            <div class="wrapper wrapper-top-inner">
        @else
        ...
        var site_url = $('meta[name="base-url"]').attr('content');
                    ...
                    $('.slider-range').each(function (index, element) {
                        ...
                        $(object_id).slider({
                            ...
                            slide: function (event, ui) {
                                $(this).parent().parent().find('.min_price_select').attr('price',ui.values[0]).html(currency+''+ui.values[0]);
                                $(this).parent().parent().find('.max_price_select').attr('price',ui.values[1]).html(currency+''+ui.values[1]);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.cart-header .p_count').html(response.data.p_count);
            ...
            $.ajax({
                ...
                success: function (response)
                {
                    ...
                    $.each(response, function(i, item) {
                        ...
                        option += '<option value="' + i + '" '+checked+'>' + item + '</option>';
                    });
