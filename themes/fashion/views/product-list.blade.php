...
<div class="wrapper-top">
                ...
                <div class="product-filter-column col-lg-3 col-md-4 col-12">
                    <div class="product-filter-body">
                        ...
                        <div class="product-widget product-filter-widget text-center">
                            ...
                            <button class="btn checkout-btn product_filter_btn" onclick="window.location='{{ route("page.product-list",$slug) }}'">
                                {{ __('Delete filter') }}
    ...
    <section class="custom-banner-section-two custom-banner-section-two-pdp">
        <div class="container">
            <div class="custom-banner-two" style="background-image: url({{asset($homepage_custom_banner_img)}});">
