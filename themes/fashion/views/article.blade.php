...
<div class="wrapper-top">
    <section class="blog-page-banner article-page-banner common-banner-section" style="background-image: url({{asset('themes/'.APP_THEME().'/assets/images/blog-banner.png')}});">
        <div class="container">
                    ...
                    <div class="common-banner-content text-center">
                        ...
                        <div class="about-user d-flex align-items-center">
                            <div class="abt-user-img">
                                <img src="{{asset('themes/'.APP_THEME().'/assets/images/john-2.png')}}">
                            </div>
                            <h6>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-12">
                    <div class="aticleleftbar">
                        ...
                        {{-- <div class="art-auther"><b>Tags:</b>@foreach ($sub as $k)
                            {{$blog->getSubId($k)}} @endforeach
                         </div> --}}
                        @php
                            ...
                            @for($i=0 ; $i < $homepage_footer_section_10['loop_number'];$i++)
                                ...
                                <li>
                                    <a target="_blank"  href="{!! $homepage_footer_10_link !!}">
                                        <img src="{{asset('/' . $homepage_footer_10_icon)}}" alt="" style="margin-bottom: inherit;">
                            ...
                            <div class="col-md-12 col-sm-6 col-12 blog-itm">
                                <div class="blog-inner">
                                    ...
                                    <div class="blog-content">
                                        <h3><a href="{{route('page.article',[$slug,$b_id])}}">{{$data->title}}</b></a> </h3>
                ...
                @endphp
                    <div class="blog-itm">
                        <div class="blog-inner">
                            ...
                            <div class="blog-content">
                                <h3><a href="{{route('page.article',[$slug,$b_id])}}">{{$article->title}}</a> </h3>
