...
$metaimage = \App\Models\Utility::GetValueByName('metaimage', $theme_name);
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Giftsforher';
...
<body>
    ...
    <!-- [ Main Content ] start -->
    <div @if (in_array(\Request::route()->getName(), ['landing_page',$slug])) class="wrapper wrapper-home"  @elseif (in_array(\Request::route()->getName(), ['page.product',$slug])) class="wrapper wrapper-home" @else class= "wrapper" @endif >
