...
@section('content')
    ...
    <section class="common-banner-section" style="background-image: url({{asset('themes/'.APP_THEME().'/assets/images/comman-banner.png') }});">
        <div class="container">
            <div class="row">
    ...
    {{-- bestseller section --}}
    <section class="our-bestseller-section our-bestseller-section-pdp tabs-wrapper">
        <div class="container">
            @php
                                            ...
                                            <div class="product-content">
                                                <div class="product-content-top">
                                                    ...
                                                    <h3 class="product-title">
                                                        <a href="{{route('page.product',[$slug,$p_id])}}" class="title">{{$product->name}}</a>
                                                    </h3>
                                                </div>
