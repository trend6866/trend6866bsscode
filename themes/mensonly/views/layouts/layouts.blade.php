@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Fashion-Man';
...
<head>
    ...
    <meta name="author" content="Gifty theme. Multipurpose Gifty Ecommerce Shopify Theme.">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <title>@yield('page-title') | {{ $title }}  </title>
    <meta name="base-url" content="{{URL::to('/')}}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Gifty theme. Multipurpose Gifty Ecommerce Shopify Theme.">
    <meta name="keywords" content="Gifty theme. Multipurpose Gifty Ecommerce Shopify Theme.">

    {{-- <meta name="keywords" content="{{ $metakeyword }}"> --}}
        {!! metaKeywordSetting($metakeyword,$metadesc,$metaimage,$slug) !!}
    {{-- <meta name="description" content="{{ $metadesc }}"> --}}

    <link rel="shortcut icon" href="{{isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicon : 'themes/'.APP_THEME().'/assets/img/favicon-icon.png'}}">
        ...
        <div class="modal modal-popup" id="commanModel" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-inner lg-dialog" role="document">
                <div class="modal-content">
                    <div class="popup-content support-modal">
