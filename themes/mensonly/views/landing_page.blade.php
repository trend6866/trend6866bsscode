...
@section('content')
    ...
    <div class="wrapper">
        ...
        <section class="home-banner-section padding-top padding-bottom">
            {{-- <img src="{{asset('themes/'.APP_THEME().'/assets/img/home-banner-ptrn.png')}}" class="home-banner-bg" alt=""> --}}
                                ...
                                <div class="row col-reverse no-gutters align-items-center">
                                            ...
                                            <div class="button-wrappper d-flex">
                                                ...
                                                <a href="javascript:void()" class="play-btn">
                                                    <img src="{{ get_file($homepage_banner_vid_btn, APP_THEME()) }}"
                                                        alt="">
                                                    <span
                                                        style="margin-left: inherit;">{{ $homepage_banner_vid_label }}</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="banner-right-col">
                                            ...
                                            <div class="hero-toltip">
                                                <div class="toltip">
                                                    <div class="hero-img-box-text">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="cauma"
                                                        ...
                                                        <h6>The best place with gifts</h6>
                                                        <span><b>John Doe,</b> Client</span>
                                                    </div>
                                                    <div class="hiro-contant-img">
                                                        <img src="{{ asset('themes/' . APP_THEME() . '/assets/img/hiro-inner-img-1.png') }}"
                                                            class="img-fluid" alt="HeroSideBoxImg">
                                                    </div>
                                                </div>
                                                <div class="toltip" style="left: -30px; top: 170px;">
                                                    <div class="hero-img-box-text">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="cauma"
                                                            width="13" height="10" viewBox="0 0 13 10"
                                                            fill="none">
                                                    ...
                                                    <div class="hiro-contant-img">
                                                        <img src="{{ asset('themes/' . APP_THEME() . '/assets/img/hiro-inner-img-2.png') }}"
                                                            class="img-fluid" alt="HeroSideBoxImg">
                                                    </div>
                                                </div>
                                                <div class="toltip" style="left: 95px; top: 350px;">
                                                    <div class="hero-img-box-text">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="cauma"
                                                            width="13" height="10" viewBox="0 0 13 10"
                                                            fill="none">
                                                    ...
                                                    <div class="hiro-contant-img">
                                                        <img src="{{ asset('themes/' . APP_THEME() . '/assets/img/hiro-inner-img-3.png') }}"
                                                            class="img-fluid" alt="HeroSideBoxImg">
                                                    </div>
                                                </div>
                                            </div>
