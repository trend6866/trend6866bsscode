                ...
                <div class="footer-col footer-link footer-link-1">
                    ...
                    <div class="footer-widget">
                        ...
                        <ul>
                            ...
                            @endphp
                            <li>
                                <a href="{!! $homepage_footer_section3_link!!}">
...
<div class="mobile-menu-wrapper">
    ...
    <div class="mobile-menu-bar">
        <div class="steps-theme-navigation desk-only">
            <h3 class="stp-head">{{ __('NAVIGATION') }}</h3>
            ...
            <div class="stp-menu-widget featured-coll-widget">
                <h4> <b>{{__('Featured')}} </b>{{__('collections')}} </h4>
                <ul>
                    ...
                    <li class="d-flex">
                        ...
                        <div class="fea-coll-contnt d-flex align-items-center">
                            <div class="fea-coll-contnt-left">
                                <h5><a href="{{route('page.product-list',[$slug,'main_category' => $category->id,'sub_category' => $featured->id ])}}">  {{$featured->name}}</a></h5>
            ...
            <div class="stp-menu-widget featured-coll-widget ">
                <h4> <b>{{__('More')}}  </b>{{__('categories:')}} </h4>
            ...
            <div class="stp-menu-widget featured-coll-widget">
                <h4> <b> {{ __('Share us,')}}  </b> {{ __('be us')}} </h4>
