                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="product-main-right">
                            ...
                            <h3 class="description ">{{ $product->SubCategoryctData->name }}</h3>
                            ...
                            <div class="d-flex price-wrap-flex align-items-center">
                                <div class="price product-price-amount price-value">
                                    <ins class="product_final_price">{{ $product->final_price }}</ins><span
                                        ...
                                        class="product_orignal_price">{{ SetNumberFormat($product->original_price) }}</del><span
                ...
                <div class="row no-gutters">
                    <div class="col-md-6 col-12 product-two-col-contnt">
                        <div class="product-two-col-left">
                            ...
                            <a href="javascript:void(0)" class="add-cart-btn addcart-btn addcart-btn-globaly"  product_id="{{ $product->id }}" variant_id="{{ $product->default_variant_id }}" qty="1">
                                <span>{{__('ADD TO CART')}}</span>
                                <span class="atc-ic">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8"
                                        viewBox="0 0 9 8" fill="none">
                        ...
                        <div class="blog-col-left ">
                            <ul class="d-flex tabs">
                                ...
                                @if ($product->product_attribute != '')
                                    <li class="tab-link on-tab-click" data-tab="33"><a
                                        ...
                                        <div class="col-md-6 col-12 product-two-col-contnt">
                                            <div class="product-two-col-left">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="add-cart-btn addcart-btn addcart-btn-globaly"
                            ...
                            <div class="product-card-inner">
                                ...
                                <div class="product-card-content">
                                    ...
                                    <a href="javascript:void(0)" class="add-cart-btn addcart-btn-globaly"
                                        product_id="{{ $data->id }}" variant_id="0" qty="1" tabindex="0">
                                        <span>{{ __('ADD TO CART') }}</span>
                                        <span class="atc-ic">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8"
                                                viewBox="0 0 9 8" fill="none">
