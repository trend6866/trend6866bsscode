                            ...
                            <div class="card-body pt-0">
                                <address class="mb-0 text-sm">
                                    <dl class="row mt-4 align-items-center">
                                        ...
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['delivery_informations']['city']) ? $order['delivery_informations']['city'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('State') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['delivery_informations']['state']) ? $order['delivery_informations']['state'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('Country') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['delivery_informations']['country']) ? $order['delivery_informations']['country'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('Postal Code') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['delivery_informations']['post_code']) ? $order['delivery_informations']['post_code'] : '' }}</small>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                <address class="mb-0 text-sm">
                                    <dl class="row mt-4 align-items-center">
                                        <small class="col-sm-4 text-sm"><b>{{ __('Name') }}</b></small>
                                        <small class="col-sm-8 text-sm pb-2">
                                        ...
                                        <small class="col-sm-4 text-sm"><b>{{ __('City') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['billing_informations']['city']) ? $order['billing_informations']['city'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('State') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['billing_informations']['state']) ? $order['billing_informations']['state'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('Country') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['billing_informations']['country']) ? $order['billing_informations']['country'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('Postal Code') }}</b></small>
                                        <small
                                            class="col-sm-8 text-sm">{{ !empty($order['billing_informations']['post_code']) ? $order['billing_informations']['post_code'] : '' }}</small>
                                        <small class="col-sm-4 text-sm"><b>{{ __('Phone') }}</b></small>
                                        <small class="col-sm-8 text-sm">
