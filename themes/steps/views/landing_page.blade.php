...
@section('content')
    @php
        $homepage_best_product_heading = $homepage_Play_Icon_Image = $homepage_header_lable = $homepage_header_video_link = $homepage_header_ellipse_ring = '';
                ...
                <div class="hiro-row">
                    <div class="hiro-column-left">
                        <div class="hiro-column-left-inner">
                            ...
                            <img class="ellipse-ring" src="{!! $homepage_header_ellipse_ring !!}">
                        </div>
    ...
    <section class="shoe-two-column-layput two-column-layput-one ">
                        ...
                        @if (!empty($landing_product))
                            <div class="common-block">
                                ...
                                <div class="thmb-pro-main">
                                    ...
                                    @if ($landing_product->Sub_image($product->id)['status'] == true)
                                ...
                                <div class="section-title">
                                    {{-- @dd($product) --}}
                                    <h2><a href="{{ route('page.product', [$slug, $p_id]) }}"
                                            class="name">{{ $landing_product->name }}
                                        </a>
                                    </h2>
                                    {{-- <div class="subtitle"> {{ $product->SubCategoryctData->name }}</div> --}}
                                </div>
                                ...
                                {{-- <div class="d-flex wrap-flex color-flex">
                                <div class="color-variant-swatch">
                                    <span class="color-lbl">COLOR
                                        VARIANTS:</span>
                                    <div class="color-list d-flex">
                                        ...
                                        <div class="pro-color">
                                            <input type="radio">
                                            <label for="yellow" style="background-color: #F16E36;"></label>
                                        </div>
                                        <div class="pro-color">
                                            <input type="radio">
                                            <label for="blue" style="background-color: #1280E5;"></label>
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
    ...
    <section class="all-the-shoes">
        ...
        <div class="container">
            ...
            <div class="all-shoes-slider flex-slider">
                        ...
                        <div class="all-shoes-itm-inner card-inner d-flex ">
                                    ...
                                    <div class="favorite-icon">
                                        <a href="javascript:void(0)" class=" wishlist wishbtn-globaly"
                                            ...
                                            <i class="{{ $product->in_whishlist ? 'fa fa-heart' : 'ti ti-heart' }}"
                                                style='color: white;    background-color: #d6d7d8;'></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="all-shoes-itm-img">
                                <div class="review-img">
                                    @for ($i = 0; $i < 5; $i++)
                                        <i
                                            class="ti ti-star {{ $i < $product->average_rating ? 'text-warning' : '' }} "></i>
                                    @endfor
                                </div>
                            ...
                            <div class="common-block commonblock-white">
                                ...
                                <div class="thmb-pro-main">
                                    <div class="thumb-pro-main-itm">
                                        <a href="{{ route('page.product', [$slug, $p_id]) }}">
                                            <img
                                                src=" {{ get_file($landing_product->cover_image_path, APP_THEME()) }}"></a>
                                    </div>
                                </div>
                                <div class="section-title">
                                ...
                                <div class="custom-output">
                                    @php
                                        ...
                                        foreach ($sale_product as $flashsale) {
                                            ...
                                            if ($currentDateTime >= $startDate && $currentDateTime <= $endDate) {
                                                if (is_array($saleEnableArray) && in_array($landing_product->id, $saleEnableArray)) {
                                                    $latestSales[$landing_product->id] = [
                                                        'discount_type' => $flashsale->discount_type,
                                                        'discount_amount' => $flashsale->discount_amount,
                                                    ];
                                                }
    ...
    <section class="meet-category-section">
        <div class="container">
            ...
            <div class="row">
                {!! \App\Models\MainCategory::HomePageCategory($slug, 3) !!}
            </div>
                    ...
                    <div class="two-coll-content">
                        @if (!empty($landing_product))
                            <div class="common-block">
                                ...
                                <div class="section-title">
                                    <h2><a href="{{ route('page.product', [$slug, $p_id]) }}"
                                            class="name">{{ $landing_product->name }}</a></h2>
                                    {{-- <div class="subtitle">{{ $product->SubCategoryctData->name }}</div> --}}
                                </div>
                                <div class="custom-output">
                                    @php
                                ...
                                <div class="custom-output">
                                    @php
                                        ...
                                        foreach ($sale_product as $flashsale) {
                                            ...
                                            if ($currentDateTime >= $startDate && $currentDateTime <= $endDate) {
                                                if (is_array($saleEnableArray) && in_array($modern->id, $saleEnableArray)) {
                                                    $latestSales[$modern->id] = [
                                                        'discount_type' => $flashsale->discount_type,
                                                        'discount_amount' => $flashsale->discount_amount,
                                                    ];
                                                }
