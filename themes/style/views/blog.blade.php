                ...
                <div class="col-md-6 col-12">
                    <div class="common-banner-content">
                        <ul class="blog-cat">
                            ...
                            {{-- <li><a href="#"><b> {{ __('Category:')}} </b> {{ __('Fashion')}} </a></li>
                            <li><a href="#"><b> {{ __('Date:')}} </b> {{ __('12 Mar, 2022')}} </a></li> --}}
                        </ul>
    ...
    <section class="blog-grid-section padding-bottom padding-top">
        <div class="container">
            ...
            <div class="blog-head-row d-flex justify-content-between">
                <div class="blog-col-left">
                    <ul class="d-flex tabs">
                        {{-- <li class="tab-link active" data-tab="0"><a href="javascript:;">All</a></li> --}}
            ...
            {{-- <div id="0" class="tab-content active">
                <div class="row blog-grid vgfgbn">
                    @foreach ($blogs as $blog)
                        <div class="col-md-4 col-sm-6 col-12 blog-widget">
                            <div class="blog-widget-inner">
                                <div class="blog-media">
                                    <a href="#">
                                        <img src="{{ $blog->cover_image_url }}" alt="" width="100" class="cover_img{{ $blog->id }}">
                                    </a>
                                </div>
                                <div class="blog-caption">
                                    ...
                                    <div class="blog-lbl-row d-flex">
                                        <div class="blog-labl">
                                            <b> Category:</b> {{$blog->MainCategory->name}}
                                        </div>
                                        <div class="blog-labl">
                                            <b>Date:</b> {{$blog->created_at->format('d M,Y ')}}
                                        </div>
                                    </div>
                                    <a class="blog-btn" href="{{route('page.article',$blog->id)}}" target="_blank">
                                        <svg viewBox="0 0 10 5">
                                            <path
                                                d="M2.37755e-08 2.57132C-3.38931e-06 2.7911 0.178166 2.96928 0.397953 2.96928L8.17233 2.9694L7.23718 3.87785C7.07954 4.031 7.07589 4.28295 7.22903 4.44059C7.38218 4.59824 7.63413 4.60189 7.79177 4.44874L9.43039 2.85691C9.50753 2.78197 9.55105 2.679 9.55105 2.57146C9.55105 2.46392 9.50753 2.36095 9.43039 2.28602L7.79177 0.69418C7.63413 0.541034 7.38218 0.544682 7.22903 0.702329C7.07589 0.859976 7.07954 1.11192 7.23718 1.26507L8.1723 2.17349L0.397965 2.17336C0.178179 2.17336 3.46059e-06 2.35153 2.37755e-08 2.57132Z">
                                            </path>
