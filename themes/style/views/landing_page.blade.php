...
<!--wrapper start here-->
    ...
    <section class="main-home-first-section">
            {!! \App\Models\Utility::HomePageProduct($slug,2) !!}
    </section>
    ...
    <section class="our-client-section padding-top padding-bottom">
        ...
        <div class="container">
            <div class="client-logo-slider common-arrows">
                {{-- @dd(count($homepage_main_logo['homepage-logo'])); --}}
                                ...
                                <div class="product-card-inner">
                                    ...
                                    <div class="product-content">
                                        <div class="product-content-top">
                                            ...
                                            <div class="product-type">{{$product->ProductData()->name}} / {{$product->SubCategoryctData->name}}</div>
                                        </div>
                                        <div
                                            ...
                                            <a href="javascript:void(0)" class="btn-secondary addcart-btn-globaly" product_id="{{ $product->id }}" variant_id="0" qty="1">
                                                {{ __('Add to cart') }}
                                                <svg viewBox="0 0 10 5">
                                                    <path
                                                        d="M2.37755e-08 2.57132C-3.38931e-06 2.7911 0.178166 2.96928 0.397953 2.96928L8.17233 2.9694L7.23718 3.87785C7.07954 4.031 7.07589 4.28295 7.22903 4.44059C7.38218 4.59824 7.63413 4.60189 7.79177 4.44874L9.43039 2.85691C9.50753 2.78197 9.55105 2.679 9.55105 2.57146C9.55105 2.46392 9.50753 2.36095 9.43039 2.28602L7.79177 0.69418C7.63413 0.541034 7.38218 0.544682 7.22903 0.702329C7.07589 0.859976 7.07954 1.11192 7.23718 1.26507L8.1723 2.17349L0.397965 2.17336C0.178179 2.17336 3.46059e-06 2.35153 2.37755e-08 2.57132Z">
                    ...
                    <div class="product-card-inner">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-content-bottom d-flex align-items-center justify-content-between">
                                ...
                                <a href="javascript:void(0)" class="btn-secondary addcart-btn-globaly" product_id="{{ $items->id }}" variant_id="0" qty="1">
                                    {{ __('Add to cart') }}
                                    <svg viewBox="0 0 10 5">
                                        <path
                                            d="M2.37755e-08 2.57132C-3.38931e-06 2.7911 0.178166 2.96928 0.397953 2.96928L8.17233 2.9694L7.23718 3.87785C7.07954 4.031 7.07589 4.28295 7.22903 4.44059C7.38218 4.59824 7.63413 4.60189 7.79177 4.44874L9.43039 2.85691C9.50753 2.78197 9.55105 2.679 9.55105 2.57146C9.55105 2.46392 9.50753 2.36095 9.43039 2.28602L7.79177 0.69418C7.63413 0.541034 7.38218 0.544682 7.22903 0.702329C7.07589 0.859976 7.07954 1.11192 7.23718 1.26507L8.1723 2.17349L0.397965 2.17336C0.178179 2.17336 3.46059e-06 2.35153 2.37755e-08 2.57132Z">
                                ...
                                @for($i=0 ; $i < $homepage_rating_box['loop_number'];$i++)
                                    ...
                                    <div class="col-sm-4 col-4">
                                        <div class="rating-box">
                                            ...
                                            <h3>{!! $homepage_rating_box_count !!}</h3>
                        ...
                        <div class="product-card-inner">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-content-bottom d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="javascript:void(0)" class="btn-secondary addcart-btn-globaly" product_id="{{ $data->id }}" variant_id="0" qty="1">
                                        {{ __('Add to cart') }}
                                        <svg viewBox="0 0 10 5">
                                            <path
                                                d="M2.37755e-08 2.57132C-3.38931e-06 2.7911 0.178166 2.96928 0.397953 2.96928L8.17233 2.9694L7.23718 3.87785C7.07954 4.031 7.07589 4.28295 7.22903 4.44059C7.38218 4.59824 7.63413 4.60189 7.79177 4.44874L9.43039 2.85691C9.50753 2.78197 9.55105 2.679 9.55105 2.57146C9.55105 2.46392 9.50753 2.36095 9.43039 2.28602L7.79177 0.69418C7.63413 0.541034 7.38218 0.544682 7.22903 0.702329C7.07589 0.859976 7.07954 1.11192 7.23718 1.26507L8.1723 2.17349L0.397965 2.17336C0.178179 2.17336 3.46059e-06 2.35153 2.37755e-08 2.57132Z">
    ...
    <section class="home-conent-section">
        <div class="container">
            @php
    ...
    <section class="our-products-shop-section padding-bottom">
        <div class="container">
            @php
                                        ...
                                        <div class="product-card-inner">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="product-content-bottom d-flex align-items-center justify-content-between">
                                                    ...
                                                    <button class="addtocart-btn addcart-btn-globaly" product_id="{{ $homeproduct->id }}" variant_id="0" qty="1">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 column-right-caption">
                    ...
                    <div class="columnl-right-caption-inner">
                       ...
                       <p> {!! $homepage_section_layout2_subtext !!}</p>
                    ...
                    <div class="product-card-inner">
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-content-bottom d-flex align-items-center justify-content-between">
                                ...
                                <div class="custom-output">
                                    @php
                                        ...
                                        foreach ($sale_product as $flashsale) {
                                            ...
                                            if ($currentDateTime >= $startDate && $currentDateTime <= $endDate) {
                                                if (is_array($saleEnableArray) && in_array($discount_product->id, $saleEnableArray)) {
                                                    $latestSales[$discount_product->id] = [
                                                        'discount_type' => $flashsale->discount_type,
                                                        'discount_amount' => $flashsale->discount_amount,
                                                    ];
                                                }
                                ...
                                <a href="javascript:void(0)" class="btn-secondary addcart-btn-globaly" product_id="{{ $discount_product->id }}" variant_id="0" qty="1">
                                    {{ __('Add to cart') }}
                                    <svg viewBox="0 0 10 5">
                                        <path
                                            d="M2.37755e-08 2.57132C-3.38931e-06 2.7911 0.178166 2.96928 0.397953 2.96928L8.17233 2.9694L7.23718 3.87785C7.07954 4.031 7.07589 4.28295 7.22903 4.44059C7.38218 4.59824 7.63413 4.60189 7.79177 4.44874L9.43039 2.85691C9.50753 2.78197 9.55105 2.679 9.55105 2.57146C9.55105 2.46392 9.50753 2.36095 9.43039 2.28602L7.79177 0.69418C7.63413 0.541034 7.38218 0.544682 7.22903 0.702329C7.07589 0.859976 7.07954 1.11192 7.23718 1.26507L8.1723 2.17349L0.397965 2.17336C0.178179 2.17336 3.46059e-06 2.35153 2.37755e-08 2.57132Z">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8 col-12">
                    <div class="blog-right-column-inner">
                        {!! \App\Models\Blog::HomePageBlog($slug,2) !!}
                    </div>
                </div>
            </div>
