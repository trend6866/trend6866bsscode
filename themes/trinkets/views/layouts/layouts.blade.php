...
$metaimage = \App\Models\Utility::GetValueByName('metaimage', $theme_name);
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Jewellery Collection - Workdo';
...
<head>
    ...
    <meta name="author" content="Jewellery Collection - Workdo.">
            ...
            success: function (response)
                {
                    ...
                    if (response.status == 0) {
                        ...
                        $(this).find('i').hasClass('ti ti-heart') ?  $(this).find('i').removeClass('ti ti-heart') : $(this).find('i').addClass('ti ti-heart');
                        $(this).find('i').hasClass('fa fa-heart') ?  $(this).find('i').removeClass('fa fa-heart') : $(this).find('i').addClass('fa fa-heart');
