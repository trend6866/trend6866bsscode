...
@endphp
<div class="col-lg-4 col-md-6 col-sm-6 col-12 product-card theme-colored-card ">
    <div class="product-card-inner">
        ...
        <div class="product-content-bottom">
            ...
            <div class="product-info">
                ...
                <button class="addtocart-btn btn addtocart-btn-cart addcart-btn-globaly" tabindex="0" product_id="{{ $product->id }}" variant_id="{{ $product->default_variant_id }}" qty="1">
