        ...
        <div class="wrapper">
         ...
         <div class="container">
                <div class="row align-items-center justify-content-between  ">
                    ...
                    <div class=" col-md-4 col-12">
                        <div class="img-wrapper">
                        <img src="{{ get_file($description_img , APP_THEME()) }}" alt="img">
                        </div>
                    </div>
                    @if ($product_stocks->isNotEmpty())
                        <div class=" col-md-3 col-12">
                            <div class="right-side">
                                <div class="right-side-inner">
                                    ...
                                    <div class="d-flex">
                                        <div class="code">
                                            <div>{{__('SKU:')}} @foreach ($product_stocks as $product_stock)<span>{{$product_stock->sku}},</span>@endforeach</div>
                                            <div>{{__('CATEGORY:')}} <span>{{ $product->ProductData()->name }}</span></div>
                                        </div>
                                        <div class="details">
                                            <div> {{__('Size:')}} @foreach ($product_stocks as $product_stock)<span>{{$product_stock->variant}},</span>@endforeach</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="pro-card-slider-section padding-bottom">
                <div class="container">
                    <div class="section-title d-flex justify-content-between align-items-center ">
                        <h3>{{ __('Barbecue & Grill') }} <b>{{ __('acessories') }}</b></h3>
                        <a href="{{ route('page.product-list', $slug) }}" class="btn-secondary show-more-btn">
