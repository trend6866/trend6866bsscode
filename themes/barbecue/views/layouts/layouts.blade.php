...
<body @if (in_array(\Request::route()->getName(), [$slug,'landing_page','page.product'])) class="bg-dark-wrapper home-page" @else class="home-page" @endif>
