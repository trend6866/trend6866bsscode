...
@section('content')
    ...
    $homepage_collection_key = array_search('home-collection-1', array_column($theme_json, 'unique_section_slug'));
    if ($homepage_collection_key != '') {
        ...
        foreach ($homepage_collection['inner-list'] as $key => $value) {
            if ($value['field_slug'] == 'home-collection-1-title') {
                $collection_heading = $value['field_default_text'];
            }
            if ($value['field_slug'] == 'home-collection-1-description') {
    ...
    <div>
                ...
                <div class="product-heading-row row no-gutters">
                    ...
                    <div class="product-heading-right-column col-lg-9 col-md-8 col-11">
                        <div class="product-sorting-row d-flex align-items-center justify-content-between">
                            <div class="filter-select-box d-flex align-items-center" style="margin: auto;
        ...
        @if($homepage_best['section_enable'] == 'on')
            <section tion class="pro-card-slider-section padding-bottom">
            <div class="container">
