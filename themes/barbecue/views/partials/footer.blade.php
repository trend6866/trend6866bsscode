            ...
            <div class="container">
                ...
                <div class="footer-bottom">
                    <div class="row align-items-center">
                        ...
                        @endif
                        @php
                            $homepage_footer_key7 = array_search('homepage-footer-8', array_column($theme_json, 'unique_section_slug'));
                            ...
                            <ul class="policy-links d-flex align-items-center justify-content-end">
                                @for($i=0 ; $i < $homepage_footer_section7['loop_number'];$i++)
                                    @php
                                        ...
                                        {
                                            if($homepage_footer_section7_value['field_slug'] == 'homepage-footer-label-text') {
                                                $homepage_footer_section7_text = $homepage_footer_section7_value['field_default_text'];
                                            }
                                            if($homepage_footer_section7_value['field_slug'] == 'homepage-footer-label-link') {
                                            ...
                                            {
                                                if($homepage_footer_section7_value['field_slug'] == 'homepage-footer-label-text'){
                                                    $homepage_footer_section7_text = $homepage_footer_section7[$homepage_footer_section7_value['field_slug']][$i];
                                                }
                                                if($homepage_footer_section7_value['field_slug'] == 'homepage-footer-label-link'){
                                    ...
                                    @endphp
                                     <li><a href="{{$homepage_footer_section7_link}}">{!! $homepage_footer_section7_text !!} </a> </li>
                                @endfor
                            </ul>
                        </div>
                    </div>
