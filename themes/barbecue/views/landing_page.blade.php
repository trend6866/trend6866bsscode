...
@section('content')
                                ...
                                <div class="product-card-inner">
                                    ...
                                    <div class="card-bottom">
                                        ...
                                        @if ($h_product->variant_product == 0)
                                            <div class="price">
                                                <ins>{{ $h_product->final_price }}<span
                                                ...
                                                <div class="product-card-inner">
                                                    ...
                                                    <div class="card-bottom">
                                                        ...
                                                        {{-- <div class="select-box">
                                                            <label>MODEL:</label>
                                                            <select>
                                                                <option data-display="Select">40cm x 60cm / stainless metal</option>
                                                                <option value="1">Knives & Pans</option>
                                                                <option value="2">Meat spicy</option>
                                                                <option value="4">Knives & Pans</option>
                                                            </select>
                                                        </div> --}}
                                                        @if ($product->variant_product == 0)
                                                            <div class="price">
    ...
    @if ($homepage_modern['section_enable'] == 'on')
        <section class="more-cat-item-section"
            style="background-image:url({{ asset('themes/' . APP_THEME() . '/assets/images/more-cat-banner.png') }});">
    ...
    {{-- <div class="subscribe-popup">
        <h2>{{__('Sign up our newsletter')}}</h2>
        ...
        <p>{{__('Subscribe our newsletters now and stay up-to-date with new collections')}}</p>
