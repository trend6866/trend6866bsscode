    ...
    <div class="product-card-inner">
        ...
        <div class="card-bottom">
            <div class="product-title">
                <h4>
                    <a href="{{route('page.product',[$slug,$p_id])}}" class="description"> {{$product->name}} </a>
                </h4>
            </div>
            <div class="card-bottom-content">
                ...
                @endif
                <a href="#" class="btn addcart-btn-globaly" type="submit" product_id="{{ $product->id }}" variant_id="0" qty="1">
                    {{ __('Add to cart')}}
...
<div class="d-flex justify-content-center col-12">
    <nav class="dataTable-pagination">
        <ul class="dataTable-pagination-list">
            <li class="pagination" style="margin-left: 678px;" >
