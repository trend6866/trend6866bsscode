    ...
    <section class="home-section">
                        ...
                        <div class="home-col d-flex">
                            <div class="home-text">
                                <div class="home-text-inner">
                                    ...
                                    <ul class="bike-ass-details">
                                        <li>
                                            <p class="descriptions">{!! $homepage_product->description !!}</p>
                                        </li>
                                    </ul>
                                    <a href="javascript:void(0)" class="btn addcart-btn-globaly" type="submit" product_id="{{ $homepage_product->id }}" variant_id="0" qty="1">
                                        {{ __('ADD TO CART')}}
        ...
        <div class="home-slider-arrow">
            <div class="home-arrow-inner">
                <div class="degree">{{__('Green Bicycle for Womans')}}</div>
            </div>
        </div>
    </section>
                    ...
                    <div class="product-card-inner">
                        <div class="card-top">
                            <div class="card-top-inner">
                                ...
                                @auth
                                <a href="javascript:void(0)" class="add-wishlist wbwish wishbtn-globaly" product_id="{{$product->id}}" in_wishlist="{{ $product->in_whishlist ? 'remove' : 'add'}}">
                                    <span class="wish-ic">
                        ...
                        <div class="card-bottom">
                            ...
                            <div class="card-bottom-content">
                                ...
                                @endif
                                <a href="javascript:void(0)" class="btn addcart-btn-globaly" type="submit" product_id="{{ $product->id }}" variant_id="0" qty="1">
                                    {{ __('Add to cart')}}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="17"
                                        viewBox="0 0 22 17" fill="none">
                                        <path
                ...
                <div class="testi-slides">
                    <div class="testi-inner">
                        ...
                        <div class="ratings d-flex align-items-center">
                            @for ($i = 0; $i < 5; $i++)
                                <i class="fa fa-star {{ $i < $review->rating_no ? 'text-black' : '' }} "></i>
                            @endfor
