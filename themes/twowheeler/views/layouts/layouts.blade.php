@php
    ...
    $store = \App\Models\Store::where('slug', $slug)
        ->where('is_active', '1')
        ->first();
    $title = \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : 'Bicycle';
...
<head>
    ...
    <meta name="author" content="Bicycles and accessories">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <title>@yield('page-title') - {{ $title }} </title>
    <meta name="base-url" content="{{ URL::to('/') }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Bicycles and accessories.">
    <meta name="keywords" content="Bicycles and accessories.">
