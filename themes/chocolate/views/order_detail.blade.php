...
<body>
    ...
    <div class="wrapper" style="margin-top: 132.361px;">
        ...
        <div class="social-media footer-col footer-link footer-link-3">
            <div class="container footer-widget">
                ...
                @endphp
                <ul class="social-icons social-links justify-content-end social-ul d-flex">
                        ...
                        @if ($homepage_footer_section7['section_enable'] == 'on')
                            <li>
                                <a href="{{ $homepage_footer_section7_social_link }}" target="_blank">
                                    <img src="{{ get_file($homepage_footer_section7_sub_title, APP_THEME()) }}" alt="youtube">
                                </a>
                            </li>
                        @endif
                    @endfor
