                ...
                <div class="product-card">
                    <div class="product-card-inner">
                            ...
                            @endforeach
                                <div class="like-items-icon">
                                    <a class="add-wishlist wishbtn wishbtn-globaly" href="javascript:void(0)"
                                        title="Wishlist" tabindex="0" product_id="{{ $data->id }}"
                        ...
                        <div class="product-card-image">
                            <a href="{{ route('page.product', [$slug, $pro_id]) }}">
                        ...
                        <div class="card-bottom">
                            <div class="product-title">
                                ...
                                <h3>
                                    <a class="product-title1" href="{{ route('page.product', [$slug, $pro_id]) }}">
                                        {{ $data->name }}
                                    </a>
                                </h3>
                            </div>
