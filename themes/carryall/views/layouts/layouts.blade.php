...
@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'carryall';
...
<head>
    ...
    <link rel="shortcut icon" href="{{isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicon : 'themes/'.APP_THEME().'/assets/images/fevicon.png'}}">
...
<body @if (in_array(\Request::route()->getName(), ['landing_page','page.product'])) class="bg-dark-wrapper" @else @endif>
