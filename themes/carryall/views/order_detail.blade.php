...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Dela+Gothic+One&family=Outfit:wght@100;200;300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
            ...
            <div class="container">
                <div class="navigationbar-row d-flex align-items-center">
                    <div class="logo-col">
                        <h1>
                            <a href="#">
                                <img h="2px" style =" margin-bottom: 30px; margin-top: 30px;"
                                    class ="logo-detail "src="{{ isset($theme_logo) && !empty($theme_logo) ? $theme_logo : 'themes/' . APP_THEME() . '/assets/images/logo.png' }}"
                                    alt="Nav brand">
                            </a>
                        </h1>
                    </div>
                    <span class="store-info-block ms-2">{{ $store->name }}</span>
                    <div class="menu-items-col justify-content-end right-side-header">
    ...
    <div class="wrapper" style="margin-top: 132.361px;">
                            ...
                            <div class="col-xl-7">
                                <div class=" d-flex all-button-box justify-content-md-end justify-content-end text-end">
                                    ...
                                    @if (
                                        ...
                                        <a class="delstatus btn btn  continue-btn " style="margin-left: 5px"
                                            data-id ="{{ $order['id'] }}">
        ...
        <div class="footer-col social-icons">
            <div class="footer-widget">
                ...
                @endphp
                <ul class="social-ul social-icons social-links justify-content-end">
                    @for ($i = 0; $i < $homepage_footer_section7['loop_number']; $i++)
                        ...
                        @if ($homepage_footer_section7['section_enable'] == 'on')
                            <li>
                                <a href="{{ $homepage_footer_section7_social_link }}" target="_blank">
