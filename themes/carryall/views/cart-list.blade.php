...
<div class="container">
    <div class="section-title">
        ...
        <h2> {{ __('Shopping') }} <b> {{ __('cart') }} </b> <span>({{ $response->data->cart_total_product }})</span></h2>
    </div>
    <div class="row">
                    ...
                    <tbody>
                        @if (!empty($response->data->cart_total_product))
                            ...
                            <tr>
                                ...
                                <td data-label="Name">
                                    <a class="product-title1" href="{{route('page.product', [$slug,hashidsencode($item->product_id)])}}">{{ $item->name }}</a>
                                ...
                                <td>
                                    <a href="JavaScript:void(0)" class="remove-btn py-1 remove_item_from_cart" title="Remove item" data-id="{{ $item->cart_id }}">
            ...
            <div class="cart-summery">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="cart-sum-right discount_final_price">{{ SetNumberFormat($final) }}</span>
                    </li>
                </ul>
                @if($is_checkout_login_required == 'on' && empty(auth::user()))
                    <a class="btn checkout-btn" href="{{ route('login',$slug) }}">
