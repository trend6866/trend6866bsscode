@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Garden';
...
<body class="home-page">
    ...
    <!-- [ Main Content ] start -->
    <div class="{{ $route_name == ['landing_page'] ? 'wrapper' : 'about-wrapper' }}">
