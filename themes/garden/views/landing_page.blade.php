    ...
    <div class="wrapper">
        ...
        @for ($i = 0; $i < $homepage_header_section4['loop_number']; $i++)
            ...
            @php
                $i == 0;
            @endphp
            <img src="{{ get_file($homepage_header_section4_img, APP_THEME()) }}" alt="leaf"
                id="{{ $i == 0 ? 'left-side-img' : 'right-side-img' }}">
        @endfor
        <div class="main-top">
            <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/leaf-design.png') }}" id="leaf-design" alt="leaf-design">
            <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/circle-design.png') }}" id="circle-design1"
                alt="circle-design">
            <!-- hero section start  -->
            @php
            ...
            @if ($homepage_header_section3['section_enable'] == 'on')
                <section class="hero-sec" style="margin-top: 200px;">
                    <div class=" container">
            ...
            @if ($homepage_bestseller['section_enable'] == 'on')
                <section class="best-seller-sec mb-6">
                    <div class=" container">
        ...
        <div class="main-center">
            ...
            @if ($homepage_counting3['section_enable'] == 'on')
                <section class="couner-number-sec mb-6">
                    <div class=" container">
                            ...
                            @for ($i = 0; $i < $homepage_counting3['loop_number']; $i++)
                                ...
                                <div class="col-lg-3 col-sm-3 col-12">
                                    <div class="number-box">
                                        <h2 data-max="100">{!! $homepage_counting3_text !!}</h2>
                                                ...
                                                <div class="inner-card">
                                                    <div class="wishlist-wrapper">
                                                            <a href="JavaScript:void(0)" class="add-wishlist wishlist wishbtn wishbtn-globaly" title="Wishlist" tabindex="0"
                                                                product_id="{{ $m_product->id }}" in_wishlist="{{ $m_product->in_whishlist ? 'remove' : 'add' }}">{{ __('Add to wishlist') }}
                                                                <span class="wish-ic">
                                                                    <i class="{{ $m_product->in_whishlist ? 'fa fa-heart' : 'ti ti-heart' }}"></i>
                                                                </span>
                                                            </a>
                                                    </div>
                                                    <div class="card-heading">
            ...
            @endif
            @php
                $homepage_video_heading_label = $homepage_video_heading_text = $homepage_video_heading_sub_text = $homepage_video_heading_icon = $homepage_video_heading_icon_text = '';
            ...
            @if ($homepage_video['section_enable'] == 'on')
                <section class="sixth-sec mb-6"
                    style="background-image: url({{ asset('themes/' . APP_THEME() . '/assets/images/banner1.png') }});">
                    <div class=" container">
                        <div class="common-heading">
        ...
        <div class="main-bottom">
            ...
            <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/leaf2.png') }}" class="desk-only" id="leaf3"
                alt="leaf">
            <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/leaf2.png') }}" class="desk-only" id="leaf4"
                alt="leaf">
            @php
        ...
        <div class="back-to-top" title="go to top">
            <a href="#">
                <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/icons/down-arrow.svg') }}" alt="down-arrow">
            </a>
        </div>
        <!-- Back to Top btn end-->
