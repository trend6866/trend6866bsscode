...
@section('content')
    <div class="wrapper" style="margin-top: 128.391px;">
        <section class="register-page padding-bottom">
            <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="mobile" class="form-control" placeholder="1234567890" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-container">
                                    <h3>{{__('Your')}} <b>{{__('Password')}}</b></h3>
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                ...
                                <div class="form-container">
                                    <div class="row">
                                        <div class="col-sm-6 col-12">
                                            <h3><b>{{__('Subscribe')}}</b> {{__('our newsletter?')}}</h3>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="row">
                                                <div class="col-6">
                                    ...
                                    <div class="row align-items-center form-footer">
                                        ...
                                        <div class="col-lg-4 col-12">
                                            ...
                                            <button class="btn submit-btn common-btn" type="submit">
                                                {{__('Register')}}
