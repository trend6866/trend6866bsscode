...
<div class="payment-method-form">
                ...
                <div class="radio-group">
                    ...
                    <label for="{{ $payment_data->name }}">
                        ...
                        <div class="radio-right">
                            <img src="{{ get_file($payment_data->image , APP_THEME()) }}" alt="cod" class="paymentimag{{ $payment_data->name }}" style="width:35%">
                        </div>
                    </label>
    ...
    <div class="form-container">
        <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
            ...
            <button class="btn continue-btn payment_done common-btn2" type="button">
                {{ __('Continue') }}
