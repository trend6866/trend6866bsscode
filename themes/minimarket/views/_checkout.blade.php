            ...
            <div class="row align-items-start">
                <div class="col-lg-9 col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 ">
                                        ...
                                        <div class="btn-flex d-flex align-items-center">
                                            ...
                                            <a class=" outline-btn login-btn" href="{{ route('login',$slug) }}">
                                                {{ __('Login') }}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14"
                                                   viewBox="0 0 35 14" fill="none">
                                                   <path
                                            ...
                                            <div class="form-container">
                                                <div class="row align-items-center form-footer  ">
                                                    <div class="col-lg-12  col-12 d-flex align-items-center">
                                                        <button class="common-btn2 btn btn-secondary" type="submit">
                                                            {{ __('Login') }}
                    ...
                    <div class="checkout-page-left">
                                ...
                                <div class="your-add-form">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label> {{ __('Address') }} <sup
                                                                    aria-hidden="true">*</sup>:</label>
                                                            <select class="form-control billing_address_list">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="checkbox-custom">
                                                                <input type="checkbox" id="da"
                                                                    name="delivery_and_billing" class="delivery_and_billing">
                                                                <label for="da">
                                    ...
                                    <div class="form-container">
                                        <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
                                            <button class="btn continue-btn confirm_btn billing_done common-btn2" type="button">
                                                {{ __('Continue') }}
                        ...
                        {{-- Delivery List --}}
                        <div class="set has-children Delivery_Method_tab">
                            <a href="javascript:;" class="acnav-label">
                                <span>{{ __('Step') }} {{ Auth::check() ? '2' : '3' }}: <b>{{ __('Delivery Method') }}
                                    </b></span>
                            </a>
                            <div class="acnav-list Delivery_Method">
                        ...
                        <div class="set has-children paymentlist_data_tab">
                            <a href="javascript:;" class="acnav-label">
                                <span>Step {{ Auth::check() ? '3' : '4' }}: <b>{{ __('Payments Method') }}</b></span>
                            </a>
                        ...
                        <div class="set has-children comfirm_list_tab">
                            ...
                            <div class="acnav-list comfirm_list_data">
                                    ...
                                    <div class="row">
                                        <div class="checkout_products col-md-4 col-sm-6 col-12">
                                            <div class="order-confirm-details">
                                                ...
                                                <ul>
                                                    <li>{{__('1x Sunglasses with black ($24.99)')}}</li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="form-container">
                                    <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
                                        <button class="btn continue-btn place_order_submit common-btn2" type="submit">
                                            {{ __('Confirm Order') }}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14"
                                                viewBox="0 0 35 14" fill="none">
                                                <path
...
@push('page-script')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 0) {
                        ...
                        $('.discount_amount_currency').html(' - ' + response.data
        ...
        $(document).on('click', '.shpping_done', function(e) {
            var shipping_val = $('.shipping_change').val();
            if (shipping_val === undefined || shipping_val === null || shipping_val == 0) {
                return false;
            }
            ...
            $.ajax({
                ...
                context: this,
                success: function(response) {
                    $('.Delivery_Method_tab').removeClass('is-open');
