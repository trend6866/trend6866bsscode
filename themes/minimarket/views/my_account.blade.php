                            ...
                            <div class="form-wrapper">
                                ...
                                <div class="form-container">
                                    <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
                                        <button class="outline-btn back-btn-acc" type="submit">
                                        ...
                                        <button class="btn continue-btn common-btn2" type="submit">
                                            {{ __('Continue') }}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14"
                                                viewBox="0 0 35 14" fill="none">
                                                <path
                            ...
                            <div class="form-wrapper">
                                ...
                                <div class="form-container">
                                    <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
                                        ...
                                        <button class="common-btn2 btn continue-btn" type="submit">
                                            {{ __('Continue') }}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14"
                                                viewBox="0 0 35 14" fill="none">
                                                <path
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group list_height_css">
                                                ...
                                                {!! Form::select('country', $country_option, null, [
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group list_height_css">
                                                <label>{{ __('State') }}<sup aria-hidden="true"
                                                        class="req">*</sup>:</label>
                                                <div class="state">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group list_height_css">
                                                <label>{{ __('City') }}<sup aria-hidden="true"
                                                        class="req">*</sup>:</label>
                                                <div class="city">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="radio-group">
                                                            <input type="radio" id="yes" name="default_address"
                                                                value="1" checked />
                                                    ...
                                                    <div class="col-6">
                                                        <div class="radio-group">
                                                            <input type="radio" id="no" name="default_address"
                                                                value="0" />
