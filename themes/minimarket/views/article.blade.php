...
@foreach ($blogs as $blog)
    ...
    <section class="top-bg-wrapper "  style="background-image: url({{ asset('themes/' . APP_THEME() . '/assets/images/article-pic.png')}});">
       <div class=" container">
                              ...
                              <div class="col-lg-3 col-md-4 col-sm-6 col-12 blog-card">
                                  <div class="article-card">
                                      ...
                                      <div class="card-content blog-caption">
                                          <span>{{ $blog->MainCategory->name }}</span>
                                          <h5><a href="{{ route('page.article', [$slug,$b_id]) }}"> {{ $blog->title }} </a>
                                          </h5>
                                          <p>{{ $blog->short_description }}</p>
