...
@if ($homepage_footer_section1['section_enable'] == 'on')
    <footer class="site-footer">
        ...
        @endphp
        <img src="{{ get_file($homepage_footer_section9_img, APP_THEME()) }}" class="d-right"
            style="bottom: 0; height: 316px;">
        <img src="{{ asset('themes/' . APP_THEME() . '/assets/images/d9.png ') }}" class="d-left">
                            ...
                            <div class=" col-lg-5 col-12">
                                ...
                                @if ($homepage_footer_section10_enable == 'on')
                                    <div class="footer-icons social-media">
                                        <h2 class="footer-title">{!! $homepage_footer_section10_title !!}</h2>
                                        @php
