        ...
        @foreach ($response->data->product_list as $item)
          <div class="mini-cart-item">
             ...
             <div class="mini-cart-details">
                <p class="mini-cart-title product-title1"><a href="{{route('page.product', [$slug,hashidsencode($item->product_id)])}}">{{ $item->name }}</a></p>
       ...
       <div class="mini-cart-footer">
            @if (!empty($response->data->cart_total_product))
                ...
                <a href="{{ route('page.cart',$slug) }}">
                    <center>
                        <button class="btn checkout-btn common-btn2">
            ...
            @endif
            <a href="{{ route('page.product-list',$slug) }}" class="link-btn" style="margin-right: 46%">
