...
@endsection
@section('content')
<div class="faqs-wrapper wrapper    ">
    ...
    <section class="faq-page padding-top padding-bottom">
        @foreach ($faqs as $faq)
            <div class="container">
                <div class="section-title">
                    <h2>{{$faq->topic}}</h2>
