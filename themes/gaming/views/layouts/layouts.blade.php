...
<body
    @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-page"  @elseif (\Request::route()->getName() == 'page.product') class="product-page home-page" @else class="home-page" @endif>

    @include('partials.header')

    <!-- [ Main Content ] start -->
    <div @if ((in_array(\Request::route()->getName(), ['landing_page','page.product']))) class="" @endif class="wrapper">
