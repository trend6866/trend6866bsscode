                ...
                <div class="col-lg-3 col-md-4 col-12 my-acc-column" id="scroll">
                    <div class="my-acc-leftbar">
                        ...
                        <ul class="account-list" id="account-nav"> 
                            ...
                            <li>
                                <a href="#tab-4" data-scroll="tab-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M20 6H4C2.89543 6 2 6.89543 2 8V16C2 17.1046 2.89543 18 4 18H20C21.1046 18 22 17.1046 22 16V8C22 6.89543 21.1046 6 20 6ZM4 4C1.79086 4 0 5.79086 0 8V16C0 18.2091 1.79086 20 4 20H20C22.2091 20 24 18.2091 24 16V8C24 5.79086 22.2091 4 20 4H4Z"  fill="#67898F" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#67898F" />
                                        <path
                                            d="M19 13C18.4477 13 18 13.4477 18 14C18 14.5523 18.4477 15 19 15C19.5523 15 20 14.5523 20 14C20 13.4477 19.5523 13 19 13Z"  fill="#67898F" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            fill="#67898F" />
                                        <path
                                            d="M5 9C4.44772 9 4 9.44772 4 10C4 10.5523 4.44772 11 5 11C5.55228 11 6 10.5523 6 10C6 9.44772 5.55228 9 5 9Z"  fill="#67898F" />
                                    </svg>
                                    <span>
                            ...
                            <li>
                                <a href="#tab-8" data-scroll="tab-9">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="my-acc-rightbar"> 
                        <div id="tab-1" class="my-acc-right-content">
                            <div class="section-title">
                                <h3>{{ __('Your Personal Details') }}</h3>
                            </div>
                        ...
                        <div id="tab-3" class="my-acc-right-content">
                            ...
                            <br><br>
                            <div class="section-title"> <h3>{{ __('Address book') }}</h3> </div>
                            <div class="order-history-frame address-book-div"> </div>
                        </div>

                        {{-- <div id="tab-4" class="my-acc-right-content">
                            <div class="section-title"> <h3>{{ __('Newsletter') }}</h3> </div>
                            <div class="form-wrapper">
        ...
        @php
            ...
            if($homepage_header_1_key != '' ) {
                ...
                foreach ($homepage_header_1['inner-list'] as $key => $value) {
                    ...
                    if($value['field_slug'] == 'home-newsletter-title') {
                        $home_head = $value['field_default_text'];
                    }
                }
            }
        @endphp
            ...
            <div class="row align-items-center">
                <div class="col-md-5 col-12">
                    <div class="subscription-left-column">
                        <div class="section-title">
                            <div class="subtitle">{{$home_head}}</div>
                            <h2>{!! $home_title !!}</h2>
                        </div>
                    </div>
                </div>
