                        ...
                        <ul class="menu-right d-flex justify-content-end align-items-center">
                            ...
                            <li class="wrap header-desk-only">
                                <div class="search-header">
                                    ...
                                    <input type="text" class="searchTerm search_input" list="products" name="search_product" id="product" placeholder="SEARCH PRODUCTS...">
                            ...
                            <li class="cart-header-bg">
                                <div class="cart-header-main">
                                    <div class="cart-header">
                                        <a href="javascript:;">
                                            <span class="header-desk-only icon-lable"> <b>{{__('My Cart:')}}</b><br><b> <span id="sub_total_main_page">{{ 0 }}</span>{{__('USD')}}</b></span>
                                            <span class="count">{!! \App\Models\Cart::CartCount() !!}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 19 17" fill="#1D1D1B">
