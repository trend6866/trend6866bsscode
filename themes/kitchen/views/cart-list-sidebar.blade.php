            ...
            @foreach ($response->data->product_list as $item)
                <div class="mini-cart-item">
                    ...
                    <div class="mini-cart-details">
                        <p class="mini-cart-title"><a href="{{route('page.product', [$slug,hashidsencode($item->product_id)])}}">
                            {{ $item->name }}</a></p>
                        ...
                        <div class="pvarprice d-flex align-items-center justify-content-between">
                            <div class="price">
                                <del>{{ SetNumberFormat($item->total_orignal_price) }}{{$currency_name}}</del><ins>{{ $item->final_price }}<span>{{ $currency_name }}</span></ins>
                            </div>
