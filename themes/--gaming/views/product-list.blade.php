...
<div class="wrapper">
    @if($homepage_collection['section_enable'] == 'on')
        <section class="common-banner-section" style="background-image:url({{asset('themes/'.APP_THEME().'/assets/images/banner.png')}})">
            <div class="container">
                <div class="row">
                        ...
                        <div class="product-widget product-tag-widget">
                            <div class="pro-itm has-children {{count($sub_category_select) > 0 ? 'is-open' : ''}}">
                                ...
                                <div class="pro-itm-inner acnav-list " style="{{count($sub_category_select) > 0 ? 'display: block;  ' : ''}}">
                                    <div class="d-flex flex-wrap text-checkbox" style="gap: 7px;">
                            ...
                            <div class="pro-itm has-children">
                                ...
                                <div class="pro-itm-inner acnav-list">
                                    <div class="radio-group">
                                        ...
                                        <label for="star5">
                                            <span>
                                                <i class="product-rating ti ti-star"></i>
                                                <i class="product-rating ti ti-star"></i>
                                                <i class="product-rating ti ti-star"></i>
                                                <i class="product-rating ti ti-star"></i>
                                                <i class="product-rating ti ti-star"></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-6 col-12">
                    <div class="best-product-slider">
                        @foreach ($homeproducts as $home_product)
                        @php
