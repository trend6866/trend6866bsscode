...
<div class="container">
    <div class="section-title">
        ...
        <h2> {{ __('Shopping') }} <b> {{ __('Cart') }} </b> <span>({{ $response->data->cart_total_product }})</span>
        </h2>
    </div>
    <div class="row">
                        ...
                        @if (!empty($response->data->cart_total_product))
                            @foreach ($response->data->product_list as $item)
                                <tr>
                                    ...
                                    <td data-label="Name">
                                        <a
                                            href="{{ route('page.product', [$slug,hashidsencode($item->product_id)]) }}">{{ $item->name }}</a>
                                    ...
                                    <td data-label="quantity">
                                        <div class="qty-spinner">
                                            ...
                                            <input type="text" class="quantity 45_quatity"
                                                ...
                                                value="{{ $item->qty }}" min="01" id="quantity">
            ...
            <div class="cart-summery">
                <ul>
                    ...
                    <li>
                        ...
                        <span
                            class="cart-sum-right discount_final_price">{{ SetNumberFormat($final) }}</span>
                    </li>
                </ul>
