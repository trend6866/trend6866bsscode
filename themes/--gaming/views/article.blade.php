...
@section('content')
    @foreach ($blogs as $blog)
        <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="about-user d-flex align-items-center">
                                ...
                                <div class="post-lbl">
                                    <b>{{ __('Date') }}:</b>{{ $blog->created_at->format('d M, Y ') }}</div>
                            </div>
                        </div>
                        <div class="col-md-8 col-12">
                            <div class="aticleleftbar">
                                ...
                                <ul class="article-socials d-flex align-items-center">
                                    @php
                                        $homepage_footer = array_search('homepage-footer-7', array_column($theme_json, 'unique_section_slug'));
                                        if ($homepage_footer != '') {
                                        ...
                                        <div class="col-md-12 col-sm-6 col-12 blog-card">
                                            <div class="blog-card-inner">
                                                ...
                                                <div class="blog-content">
                                                    <h4><a href="{{ route('page.article', [$slug,$b_id]) }}"
                                                            class="short_description">{{ $data->title }}</a></h4>
            ...
            <section class="blog-grid-section padding-bottom tabs-wrapper">
                <div class="container">
                    @php
