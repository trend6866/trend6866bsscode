@php
    ...
    $store = \App\Models\Store::where('slug', $slug)
        ->where('is_active', '1')
        ->first();
    $title = \App\Models\Utility::GetValueByName('theme_name', $theme_name) ? \App\Models\Utility::GetValueByName('theme_name', $theme_name) : 'Gift Shop Workdo';
...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicon : 'themes/' . APP_THEME() . '/assets/img/favicon-icon.png' }}">
