                ...
                <div class="logo-col">
                    <h1>
                        <a href="{{ route('landing_page', $slug) }}">
                            ...
                            <img src="{{ isset($theme_logo) && !empty($theme_logo) ? $theme_logo : 'themes/' . APP_THEME() . '/assets/img/logo.png' }}"
                                alt="">
                                ...
                                <ul class="main-nav">
                                    <li class="menu-lnk has-item">
                                        <a href="#" class="category-btn active">
                                            <svg class="mr-right" xmlns="http://www.w3.org/2000/svg" width="19"
                                                height="19" viewBox="0 0 19 19" fill="none">
                                                <path
                                                    d="M17.4166 7.9165L19 10.2915L11.0834 13.4583L9.5 11.0833L17.4166 7.9165Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M10.4787 15.4056L9.5 13.9376L8.5215 15.4056L2.375 12.9473V15.8334L9.5 19L16.625 15.8334V12.9473L10.4787 15.4056Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M1.58341 7.9165L0 10.2915L7.91659 13.4583L9.5 11.0833L1.58341 7.9165Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M15.8336 1.12029L14.714 0C13.208 1.50527 12.1875 3.4884 11.8728 5.69953L10.2918 5.06706V0H8.70834V5.06635L7.12707 5.69953C6.81285 3.4884 5.79279 1.50527 4.28633 0L3.16699 1.12029C4.57727 2.52819 5.42942 4.34578 5.61633 6.30325L3.71562 7.06396L9.50017 9.37792L15.2845 7.06396L13.3842 6.30396C13.5707 4.34554 14.4233 2.5289 15.8336 1.12029Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M19 1.979C19 2.6345 18.4689 3.1665 17.8125 3.1665C17.1584 3.1665 16.625 2.6345 16.625 1.979C16.625 1.32327 17.1584 0.791504 17.8125 0.791504C18.4689 0.791504 19 1.3235 19 1.979Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M1.58341 0.791588C1.58341 1.22764 1.22787 1.58318 0.791825 1.58318C0.355775 1.58318 0 1.22764 0 0.791588C0 0.355538 0.355775 0 0.791588 0C1.2274 0 1.58341 0.355775 1.58341 0.791588Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M16.6254 4.75008C16.6254 5.18613 16.2699 5.54167 15.8338 5.54167C15.3978 5.54167 15.042 5.18613 15.042 4.75008C15.042 4.31403 15.3978 3.9585 15.8338 3.9585C16.2699 3.9585 16.6254 4.31403 16.6254 4.75008Z"
                                                    fill="#201678"></path>
                                                <path
                                                    d="M3.95801 4.354C3.95801 5.0095 3.42696 5.5415 2.77051 5.5415C2.11643 5.5415 1.58301 5.0095 1.58301 4.354C1.58301 3.69827 2.11643 3.1665 2.77051 3.1665C3.42672 3.1665 3.95801 3.6985 3.95801 4.354Z"
                                                    fill="#201678"></path>
                                            </svg>
                                            {{ __('Gifty Products') }}
                                        </a>
                                    ...
                                    <li class="menu-lnk">
                                        ...
                                        <div class="menu-dropdown">
                                            <ul>
                                                ...
                                                @endforeach
                                                <li><a href="{{ route('page.faq', $slug) }}"> {{ __('FAQs') }} </a>
                                                </li>
                                                <li><a href="{{ route('page.blog', $slug) }}"> {{ __('Blog') }} </a>
                                                </li>
                                                <li><a href="{{ route('page.product-list', $slug) }}">
                                                        {{ __('Collection') }} </a>
                                            </ul>
                                        </div>
                                    </li>
                                ...
                                <ul class="menu-right d-flex justify-content-end ">
                                    ...
                                    <li class="cart-header ">
                                        <a href="javascript:;" class="btn">
                                            ...
                                            {{ __('Cart') }}: {{ $currency_icon }}<span
                                                class="desk-only icon-lable" id="sub_total_main_page">
                                                {{ 0 }}</span>
