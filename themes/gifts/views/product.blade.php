...
@section('content')
    ...
    <div class="wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center col-reverse no-gutters product-info">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <p class="product-variant-description">{{ $product->description }}</p><br>
                                            ...
                                            @foreach ($variant as $key => $value)
                                                ...
                                                @if ($variation_option == 1)
                                                    ...
                                                    <div class="inline_contant">
                                                        <select
                                                            class="custom-select-btn product_variatin_option variant_loop radio-btn"
                            ...
                            <div class="pdp-cart-btn-wrp">
                                ...
                                @else
                                    <a href="javascript:void(0)"
                                        class="btn addtocart-btn btn addcart-btn  addcart-btn-globaly price-wise-btn product_var_option"
        ...
        <section class="pdp-page review-section padding-bottom">
            <div class="container">
                @php
        ...
        <section class="subscribe-section pdp-subscribe-sec">
            <div class="container">
                @php
