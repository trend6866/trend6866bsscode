@foreach ($products as $product)
    ...
    @endphp
    <div class="col-xl-4 col-md-6 col-sm-6 col-12 product-list-widget">
            ...
            <div class="bestseller-card-inner">
                ...
                <div class="bestseller-content">
                    ...
                    <div class="bestseller-bottom">
                        ...
                        @endif
                        <a href="javascript:void(0)" class="btn addcart-btn-globaly" tabindex="0"
...
<div class="d-flex justify-content-end row col-12">
