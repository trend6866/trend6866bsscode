        ...
        @if (!empty($response->data->data))
            @foreach ($response->data->data as $item)
                ...
                <div class="mini-wish-item">
                    ...
                    <a href="#" class="common-btn addtocart-btn addcart-btn-globaly"
                        product_id="{{ $item->product_id }}" variant_id="{{ $item->variant_id }}" qty="1"
                        style="color: black; margin-right: 166px;">
                        <span>{{ __('Check more products') }}</span>
                    </a>
            ...
            @endforeach
        @else
            <p class="emptywish text-center" style="color: black;">{{ __('You have no items in your shopping wish.') }}
            </p>
        @endif
    </div>
