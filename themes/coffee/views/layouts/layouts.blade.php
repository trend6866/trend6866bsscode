@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'CoffeeStore Black';
...
<head>
    ...
    <meta name="author"
        content="CoffeeStore Black - Workdo.">
    ...
    <link rel="shortcut icon" href="{{!empty($theme_favicon) ? $theme_favicon : asset('themes/'.APP_THEME().'/assets/images/favicon.png')}}">
