...
<div id="wish-body" class="mini-wish-has-item">
   ...
   {{-- @dd($response->data->data) --}}
      <div class="mini-wish-item">
         ...
         <div class="mini-wish-details" style="color: black;">
            ...
            <div class="pvarprice d-flex align-items-center justify-content-between">
               <div class="price">
                  ...
                  <ins>{{ $item->final_price }}<span class="currency-type">{{ $currency_name }}</span></ins>
         ...
         <div class="product-content-bottom" style="margin-left: 6px;">
            <div class="d-flex align-items-center justify-content-between">

                <a href="javascript:void(0)" class="btn addcart-btn-globaly" type="submit" product_id="{{ $item->product_id }}" variant_id="{{ $item->variant_id }}" qty="1">
                    + {{ __('ADD TO CART')}}
                </a>
            </div>
        </div>
      ...
      @endforeach
   @else
         <p class="emptywish text-center" style="color: black;">{{ __('You have no items in your shopping wish.') }}</p>
   @endif
   </div>
