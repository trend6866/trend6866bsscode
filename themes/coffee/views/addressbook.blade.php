            ...
            @foreach ($DeliveryAddress as $address)
                <tr>
                    ...
                    <td data-label="Action">
                        <i class="ti ti-eye text-black py-1 edit_address" data-id="{{ $address->id }}" data-bs-toggle="tooltip" title="edit"></i>
                        <i class="ti ti-trash text-black py-1 delete_address" data-id="{{ $address->id }}" data-bs-toggle="tooltip" title="delete"></i>
                    </td> 
                </tr>      
            @endforeach
        @else
