                    ...
                    <div class="logo-col">
                        <h1>
                            <a href="{{route('landing_page',$slug)}}">
                                <img src="{{isset($theme_logo) && !empty($theme_logo) ? $theme_logo : asset('themes/'.APP_THEME().'/assets/images/logo.png')}}" alt="">
                            </a>
                        </h1>
                    </div>
                            ...
                            <li class="menu-lnk">
                                <a href="#" class="category-btn active">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
                                        <path d="M11.4343 5.68164H0.46875V8.29201C0.46875 9.76955 1.15143 11.0859 2.21776 11.9464H0.46875V12.9906H9.8678V11.9464H8.11926C8.92539 11.2949 9.50985 10.3824 9.74749 9.33618H11.4343C12.2992 9.33618 13.0008 8.63469 13.0008 7.77V7.24783C13.0008 6.38329 12.2992 5.68164 11.4343 5.68164ZM11.9564 7.77C11.9564 8.05849 11.7224 8.29201 11.4343 8.29201H9.8678V6.72582H11.4343C11.7224 6.72582 11.9564 6.96028 11.9564 7.24783V7.77Z" fill="#ffffff"></path>
                                        <path d="M0.46875 4.63835C0.46875 2.33229 2.33916 0.460938 4.64616 0.460938C4.64616 1.32581 5.3478 2.02745 6.21267 2.02745H7.2569C8.69793 2.02745 9.8678 3.19622 9.8678 4.63835H0.46875Z" fill="#ffffff"></path>
                                    </svg>
                                </a>
                            </li>
                        </ul>
