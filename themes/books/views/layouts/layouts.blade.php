...
$metaimage = \App\Models\Utility::GetValueByName('metaimage', $theme_name);
    ...
    // $settings = \App\Models\Setting::where('theme_id', $theme_name)->pluck('value', 'name')->toArray();
    // dd($settings);
...
<html>
    ...
    <head>
        ...
        <meta name="author" content="{{ $metadesc }}">
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
        <title>{{ \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : ' Books' }} - @yield('page-title')</title>
        ...
        href="{{ isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicon : 'themes/' . APP_THEME() . '/assets/images/Favicon.png' }}">        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@100;200;300;400;500;600;700;800;900&family=Quicksand:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
            ...
            $(document).on('click', '.wishbtn-globaly', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('.wish-header .count').html(response.data.count);
