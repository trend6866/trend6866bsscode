...
<body>
    ...
    <div class="wrapper" style="margin-top: 132.361px;">
        ...
        <div class="social-media">
            <div class="container">
                @php
                $homepage_footer_key7 = array_search('home-social-links-2', array_column($theme_json, 'unique_section_slug'));
                if ($homepage_footer_key7 != '') {
                    $homepage_footer_section7 = $theme_json[$homepage_footer_key7];
                }
            @endphp
            <ul class="social-icons social-links justify-content-end footer-list-social">
                @for ($i = 0; $i < $homepage_footer_section7['loop_number']; $i++)
                    @php
                        foreach ($homepage_footer_section7['inner-list'] as $homepage_footer_section7_value) {
                            if ($homepage_footer_section7_value['field_slug'] == 'home-social-links-2-contact-image') {
                                $homepage_footer_section7_sub_title = $homepage_footer_section7_value['field_default_text'];
                            }
                            if ($homepage_footer_section7_value['field_slug'] == 'home-social-links-2-url') {
