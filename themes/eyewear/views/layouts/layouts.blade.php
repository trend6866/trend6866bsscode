@php
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Eyewear Collection - Workdo';
...
<head>
    ...
    <meta name="author" content="Eyewear Collection - Workdo.">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <title>@yield('page-title') - {{ $title }}  </title>
    {{-- <meta name="description" content="{{ $metadesc }}"> --}}
    {{-- <meta name="keywords" content="{{ $metakeyword }}"> --}}
        {!! metaKeywordSetting($metakeyword,$metadesc,$metaimage,$slug) !!}
    <link rel="shortcut icon" href="{{isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicons : 'themes/'.APP_THEME().'/assets/images/favicon.png'}}">
    {{-- @dd(asset(Storage::url($theme_favicon))); --}}
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700;1,800&display=swap"
    rel="stylesheet">
    ...
    <link rel="apple-touch-icon" href="{{ isset($theme_favicon) && !empty($theme_favicon) ? $theme_favicons : 'themes/' . APP_THEME() . '/assets/images/Favicon.png' }}">
