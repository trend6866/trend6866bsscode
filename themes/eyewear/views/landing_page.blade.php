...
<!--wrapper start here-->
    ...
    @endphp
                                        ...
                                        <div class="product-card card">
                                            <div class="product-card-inner card-inner">
                                                ...
                                                <div class="product-content-bottom">
                                                    ...
                                                    @endif
                                                    <button class="addtocart-btn btn addcart-btn-globaly" product_id="{{ $m_product->id }}" variant_id="0" qty="1">
        ...
        <section class="hot-selling-product padding-top padding-bottom">
            @php
                $homepage_text = '';
            ...
            <div class=" container">
                ...
                {!! \App\Models\Product::GetLatProduct($slug,10) !!}
