...
@endphp
<div class="col-lg-4 col-xl-4 col-md-4 col-sm-6 col-12 product-card theme-colored-card ">
    <div class="product-card-inner">
        ...
        <div class="product-content-bottom">
            ...
            {{-- <div class="product-info">
                ...
                <button class="addtocart-btn btn addtocart-btn-cart addcart-btn-globaly" tabindex="0" product_id="{{ $product->id }}" variant_id="0" qty="1">
