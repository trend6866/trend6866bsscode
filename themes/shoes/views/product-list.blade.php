...
@section('content')
    <section class="common-banner-section" style="background-image: url({{asset('themes/'.APP_THEME().'/assets/images/cart-banner.png') }});">
        <div class="container">
            <div class="row">
    ...
    <section class="padding-bottom today-discounts">
        <div class="container">
            <div class="section-title d-flex align-items-center justify-content-between">
                <h2 class="title">{{__('Today Discounts')}} <span class="new-labl bg-danger">OFF</span></h2>
