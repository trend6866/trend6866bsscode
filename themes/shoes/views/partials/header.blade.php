    ...
    <div class="main-navigationbar">
        <div class="container">
            <div class="navigationbar-row d-flex align-items-center justify-content-between">
                ...
                @else
                <div class="extra-menu-col d-flex  justify-content-between align-items-center">
                    <div class="offer-tagline">
                        <p>{!! $homepage_footer_section1_offer!!} <a href="{{route('page.product-list',$slug)}}">{{__('Show more')}}
                                </a>
                        </p>
                    </div>
                    <ul class="extra-menu-right d-flex  justify-content-end align-items-center">
                        @foreach ($pages as $page)
