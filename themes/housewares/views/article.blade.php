                                    ...
                                    @for($i=0 ; $i < $homepage_footer_section5['loop_number'];$i++)
                                        ...
                                        <li>
                                            <a href="{{$homepage_footer_section5_social_link}}">
                                                <img class="artcle-img" src="{{get_file($homepage_footer_section5_icon , APP_THEME())}}" alt="youtube">
                                            </a>
                                        </li>
                                    @endfor
                                </ul>
                                    ...
                                    <div class="blog-card-itm-inner">
                                        <div class="blog-card-image">
                                            <a href="{{route('page.article',[$slug,$b_id])}}" tabindex="0">
                                                <img src="{{get_file($data->cover_image_path , APP_THEME())}}" class="aticleleftbar-img default-img">
                                            </a>
                                            <div class="tip-lable">
