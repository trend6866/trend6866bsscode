                        ...
                        <div class="product-summery-column">
                            ...
                            <form class="variant_form w-100">
                                ...
                                <div class="cart-price">
                                    <a href="javascript:void(0)" class="btn-secondary addcart-btn addtocart-btn-cart addcart-btn-globaly" tabindex="0" product_id="{{ $product->id }}" variant_id="{{ $product->default_variant_id }}" qty="1">
                    ...
                    <div class="blog-head-row tab-nav d-flex justify-content-between">
                        <div class="blog-col-left ">
                            <ul class="d-flex tabs">
                                ...
                                @endif
                                <li class="tab-link on-tab-click tab-content active" data-tab="2"><a
                                ...
                                <div class="testimonial-itm">
                                    <div class="testimonial-itm-inner">
                                        ...
                                        <div class="testimonial-itm-image">
                                            <a href="#" tabindex="0">
                                                <img src="{{asset('/'. !empty($review->ProductData()) ? get_file($review->ProductData->cover_image_path , APP_THEME()) : '' )}}" alt="testi-img">
                                            </a>
                                        </div>
                                    </div>
                                </div>
