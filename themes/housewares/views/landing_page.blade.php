...
@section('content')
    ...
    @if($homepage_header_1['section_enable'] == 'on')
        <section class="main-home-first-section" style="background-image:url('{{ asset('themes/' . APP_THEME() . '/assets/images/main-home-bg.png') }}'); background-position: center; background-repeat: no-repeat; background-size: cover;">
                                ...
                                <div class="d-flex w-100 align-items-center no-gutters">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="banner-right-contant">
                                            @foreach ($homepage_products as $bs_product)
                                                @php
                                                            ...
                                                            <div class="pro-content-inner">
                                                                <div class="pro-content-top">
                                                                    <div class="content-title">
                                                                        ...
                                                                        <h4><a class="title" href="{{route('page.product',[$slug,$p_id])}}">{{ $bs_product->name }}</a></h4>
                                                                    </div>
                                                                </div>
                                                                <div class="price">
