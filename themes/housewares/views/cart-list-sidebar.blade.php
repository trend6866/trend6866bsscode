...
<div id="cart-body" class="mini-cart-has-item">
                ...
                <div class="mini-cart-item">
                    ...
                    @endif
                        ...
                        <div class="pvarprice d-flex align-items-center justify-content-between">
                            <div class="price">
                                <del style="padding-right: 10px;">{{ SetNumberFormat($item->total_orignal_price) }}{{$currency_name}}</del><ins>{{ $item->final_price }}<span>{{ $currency_name }}</span></ins>
                            </div>
    ...
    <div class="mini-cart-footer mini-cart-footer1">
        ...
        @endif
        <a class="cart-shipping link-btn" href="{{ route('page.product-list',$slug) }}"  >
