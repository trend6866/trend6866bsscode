            ...
            <div class="row">
                ...
                <div class="col-md-5 col-12 contact-left-column">
                    <div class="contact-left-inner row">
                        ...
                        <ul class="col-sm-6 col-12">
                            <li>
                                <h4>{{__('Address:')}}</h4>
                                <p class="address">{{isset($other_info->address) ? $other_info->address : 'Marigold Lane,Coral Way, Miami,Florida, 33169'}}
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-7 col-12 contact-right-column">
                    <div class="contact-right-inner">
                        ...
                        <form class="contact-form" action="{{ route("admin.contacts.store") }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label>{{__('Telephone')}}Telephone<sup aria-hidden="true">*</sup>:</label>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8   col-12">
                                    <div class="checkbox-custom">
                                        ...
                                        <label for="ch1">
                                            <span> {{ __('I have read and agree to the') }} <a href="{{route('privacy_page',$slug)}}"> {{ __('Terms & Conditions.') }} </a>  </span>                                         </label>
                                    </div>
                                </div>
