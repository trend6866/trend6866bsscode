            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12">
                    <div class="articlerightbar">
                        ...
                        <div class="blog-widget our-blog-itm">
                                @php
                                ...
                                <div class="our-blog-itm-inner">
                                    <div class="our-blog-img">
                                        ...
                                        <a href="{{route('page.article',[$slug,$b_id])}}" class="btn article-btn"> {{$data->MainCategory->name}}</a>
                                    </div>
                                    <div class="our-blog-content">
                                        <div class="our-blog-content-top">
                                            ...
                                            <h3><a href="{{route('page.article',[$slug,$b_id])}}">{{$data->title}}</a></h3>
