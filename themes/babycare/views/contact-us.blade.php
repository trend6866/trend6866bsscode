...
@section('content')
    <div class="wrapper wrapper-top">
        ...
        <section class="contact-page padding-top">
            @foreach ($pages_data as $page)
            <div class="container">
                <div class="row">
                    @php
                        ...
                        <div class="contact-left-inner row">
                            <ul class="col-sm-6 col-12">
                                <li>
                                    <h4>{{ __('Call us') }}:</h4>
                                    <p><a
                                            href="tel:+48 0021-32-12">{{ isset($other_info->call) ? $other_info->call : '+48 0021-32-12' }}</a>
                                    </p>
                                </li>
                                <li>
                                    <h4>{{ __('Email') }}:</h4>
                                    <p><a
                                            href="mailto:shop@company.com">{{ isset($other_info->email) ? $other_info->email : 'shop@company.com' }}</a>
                                    </p>
                                </li>
                            </ul>
                            <ul class="col-sm-6 col-12">
                                <li>
                                    <h4>{{ __('Address') }}:</h4>
                                    <p class="address">
                                        {{ isset($other_info->address) ? $other_info->address : 'Marigold Lane,Coral Way, Miami,Florida, 33169' }}
                                    </p>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subject" class="form-control" placeholder="Doe"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
