...
@section('content')
    <section class="about-us-page padding-top " style="    padding-top: 150px;
    ">
        <div class="container">
            {{-- @dd($order) --}}
            @if ( !empty($order))
                @if( !empty($order->delivered_status != 2))
                    <div class="card">
                        <div class="card-body">
                            <div
                                ...
                                <div class="profile-inf-right">
                                    <h4 class="">{{ $order_detail['delivery_informations']['name'] }}</h4>
                    ...
                    <article class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- @dd(in_array($order->delivered_status, [6])); --}}
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>{{ __('Pendding') }}</strong></li>
                                <li @if (in_array($order->delivered_status, [1, 4, 5, 6])) class="active" @endif id="personal">
                                    <strong>{{ __('Comfirmed') }}</strong></li>
                                <li @if (in_array($order->delivered_status, [1, 5, 6])) class="active" @endif id="payment">
                                    <strong>{{ __('Picked Up') }}</strong></li>
                                <li @if (in_array($order->delivered_status, [1, 6])) class="active" @endif id="confirm">
                                    <strong>{{ __('Shipped') }}</strong></li>
                                <li @if (in_array($order->delivered_status, [1])) class="active" @endif id="delivered">
                ...
                @elseif (!empty($order->delivered_status) == 2)
