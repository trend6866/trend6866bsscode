            ...
            <div class="col-md-8 col-12">
                <div class="aticleleftbar">
                    ...
                    <ul class="article-socials d-flex align-items-center">
                        ...
                        <li>
                            <a target="_blank" rel="noopener" href="//pinterest.com/pin/create/button/?url=https://style-workdo.myshopify.com&amp;media=//cdn.shopify.com/shopifycloud/shopify/assets/no-image-2048-5e88c1b20e087fb7bbe9a3771824e743c244f437e4f8ba93bbf7b11b53f7824c_1024x1024.gif&amp;description=" class="share-pinterest">
                        ...
                        <div class="col-md-12 col-sm-6 col-12 blog-widget">
                            <div class="blog-widget-inner">
                                ...
                                <div class="blog-caption">
                                    <h3><a class="title" href="{{route('page.article',[$slug,$b_id])}}">{{$data->title}}</a></h3>
            ...
            @endphp
                <div class="blog-widget">
                    <div class="blog-widget-inner">
                        ...
                        <div class="blog-caption">
                            <h3><a class="title" href="{{route('page.article',[$slug,$b_id])}}">{{$article->title}}</a></h3>
                            <p class="description">{{$article->short_description}}</p>
                            <div class="blog-lbl-row d-flex">
                                <div class="blog-labl">
                                    <b> {{ __('Category:')}} </b> {{$article->Maincategory->name}}
                                </div>
                                <div class="blog-labl">
