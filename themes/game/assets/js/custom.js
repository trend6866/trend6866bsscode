/*  jQuery Nice Select - v1.0
    ...
    $(document).ready(function () {
        ...
        $('ul.tabs li').click(function () {
            ...
            $(this).closest('.best-tabs').find('.tab-link').removeClass('active');
            $(this).addClass('active');
            $(this).closest('.best-tabs').find('.tab-content').removeClass('active');
            $(this).closest('.best-tabs').find('.tab-content#' + tab_id).addClass('active');
            $(this).closest('.best-tabs').find('.shop-protab-slider').slick('refresh');
            $(this).closest('.best-tabs').find('.cat-protab-slider').slick('refresh');
        });
