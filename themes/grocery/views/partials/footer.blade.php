...
{{-- @if (in_array(\Request::route()->getName(), ['landing_page','page.product'])) --}}

{{-- <div style="{{$key== 0 ? '"padding-top: 350px;"' :  ''}}"> --}}
            ...
            <div class="footer-row">
                ...
                <div class="footer-col footer-link footer-link-1">
                    <div class="footer-widget">
                        ...
                        @endphp
                        {{-- @if ($homepage_footer_section1 == 'on') --}}
                        @if ($homepage_footer_section1_checkbox == 'on')

                            <h2> {!! $homepage_footer_section1_title !!} </h2>
                            @php
                    ...
                    <div class="col-12 col-md-6">
                        <ul class="policy-links d-flex align-items-center justify-content-end">
                            ...
                            @php
                                ...
                                $homepage_footer_key3 = array_search('homepage-footer-8', array_column($theme_json, 'unique_section_slug'));
                                if ($homepage_footer_key3 != '') {
                                    $homepage_footer_section3 = $theme_json[$homepage_footer_key3];
                                }
                            @endphp
