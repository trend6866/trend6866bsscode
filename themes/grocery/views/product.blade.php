                                        ...
                                        <div class="">
                                            <div class="user-pro-list">
                                                <ul class="d-flex align-items-center">
                                                    <li>
                                                        <img src="{{ get_file($homepage_best_product_img) }}"
                                                            alt="user1">
                                                    </li>
                                                        ...
                                                        <div class="product-content-top">
                                                            ...
                                                            <div class="reviews-stars-wrap d-flex align-items-center">
                                                                <div class="reviews-stars-outer">
                                                                    @for ($i = 0; $i < 5; $i++)
                                                                        <i
                                                                            class="ti ti-star review-stars {{ $i < $data->average_rating ? 'text-warning' : '' }} "></i>
                                                                    @endfor
                                                                </div>
                                                                <div class="point-wrap">
                                                                    <span
                                                                        class="review-point">{{ $data->average_rating }}.0
                                                                        / <span>5.0</span></span>
                                                                </div>
                                                            </div>
                                                        </div>
