...
<div class="home-wrapper">
                    ...
                    <div class="home-banner-contain">
                        ...
                        <div class="banner-tagline">
                            <div class="tagline-row d-flex align-items-center">
                                ...
                                <p>{{$header_title}}
                                    {{-- <a href="{{route('page.product-list')}}">\{{$homepage_text3}}</a> --}}
                                </p>
                            </div>
                        </div>
                ...
                <div class="product-card-inner">
                    ...
                    <div class="product-content">
                        <div class="product-content-bottom d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="btn-primary add-cart-btn addcart-btn-globaly" product_id="{{ $bestSellers->id }}" variant_id="{{ $bestSellers->default_variant_id }}" qty="1">
                                {{ __('Add to cart')}}
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="full-width-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <div class="product-content-bottom d-flex align-items-center justify-content-between">
                                        <div class="price">
                                            <ins>{{$latest_product->final_price}}
                                                <span class="currency-type">{{$currency}}</span>
                                            </ins>
                                        </div>
                                        <a href="javascript:void(0)" class="btn-primary add-cart-btn addcart-btn-globaly" product_id="{{ $latest_product->id }}" variant_id="{{ $latest_product->default_variant_id }}" qty="1">
                                            {{ __('Add to cart')}}
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="full-width-second-section">
        {{-- <img src="{{asset('themes/'.APP_THEME().'/assets/images/about-us.png')}}"> --}}
        <div class="full-container">
                                ...
                                {{-- <div class="product-content-top">
                                    ...
                                    <div class="slide-select-box">
                                        <div class="nice-select" tabindex="0"><span class="current">i7-9700K</span>
                                            <ul class="list">
                                                <li data-value="Gray Pot (20cm)" data-display="Gray Pot (20cm)" class="option selected">i7-9700K</li>
