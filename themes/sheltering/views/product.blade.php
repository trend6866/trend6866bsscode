            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="product-left-inner">
                                    ...
                                    <div class="size-select d-flex mb-5">
                                        ...
                                        @foreach ($variant as $key => $value)
                                            ...
                                            @if ($attribute->type != 'collection_horizontal')
                                                <select class="col custom-select-btn variont_option" name="varint[{{ $attribute->name }}]">
                        ...
                        <div class="product-content-bottom d-flex align-items-center justify-content-between" style="margin-top: 15px;">
                            <div class="price">
                                <ins class="product_final_price">{{$product->final_price}}{{$currency}}</ins>&nbsp;
                                <span class=" currency-type">{{$currency}}</span>
                            </div>
                            <a href="javascript:void(0)" class="btn-primary addcart-btn addcart-btn-globaly" product_id="{{ $product->id }}" variant_id="{{ $product->default_variant_id }}" qty="1">
                                {{ __('Add to cart')}}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="slider-wrapper">
                        <div class="product-thumb-slider">
                            ...
                            <div class="product-thumb-item">
                                <div class="thumb-img">
                                    <img src="{{get_file($item->image_path , APP_THEME())}}" alt="product-img">
                                </div>
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-12">
                    <div class="pro-descrip-right">
                        ...
                        <ul class="row">
                            <li class="">
                                <span>{{__('SKU:')}} @foreach($product_stocks as $product_stock)<b >{{$product_stock->sku}},</b>@endforeach</span>
                                <span>{{__('Category:')}}@foreach($product_stocks as $product_stock)<b>{{$product_stock->variant}},</b>@endforeach</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="tabs-wrapper">
            <div class="blog-head-row tab-nav d-flex justify-content-between">
                <div class="blog-col-left ">
                    <ul class="d-flex tabs">
                        <li class="tab-link on-tab-click active" data-tab="00"><a
                                href="javascript:;">{{ __('Description') }}</a>
                        </li>
                        @if($product->preview_content != '')
                        <li class="tab-link on-tab-click" data-tab="11"><a
                                href="javascript:;">{{ __('Video') }}</a>
                        </li>
                        @endif
                        <li class="tab-link on-tab-click" data-tab="22"><a
            ...
            <div class="tabs-container">
                <div id="00" class="tab-content active">
            ...
            <div class="d-flex align-items-center">
                <div class="col-xl-4 col-lg-4 col-md-6 col-12 pro-tab-left">
                    <div class="left-column-img">
                        <img src="{{asset('themes/'.APP_THEME().'/assets/images/img1.png')}}" class="cpu-left" alt="image">
                    </div>
                </div>
                                ...
                                @foreach($MainCategoryList as $CategoryList)
                                    @if($CategoryList->id == $category->id)
                                        <div class="product-tab-img">
                                            <img src="{{get_file($CategoryList->image_path , APP_THEME())}}" class="product-img" alt="image">
                                        </div>
                                    @endif
                                @endforeach
                            </div>
    ...
    <section class="home-product-extra  padding-bottom">
        <div class="container">
            ...
            <div class="product-extra-slider dark-contnt">
                ...
                {!! \App\Models\Product::ProductPageBestseller() !!}
