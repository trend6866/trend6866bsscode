...
<div class="wrapper" style="">
    ...
    <section class="product-listing-section padding-bottom">
        <div class="product-heading-row">
            <div class="container">
                <div class=" row  ">
                    <div class="product-heading-column col-lg-3 col-md-4 col-2">
                    ...
                    <div class="product-heading-right-column col-lg-9 col-md-8 col-10">
        ...
        <div class="container">
            <div class="product-list-row row">
                <div class="product-filter-column col-lg-3 col-md-4 col-12">
                    <div class="product-filter-body">
                       ...
                       <div class="product-widget product-tag-widget">
                        ...
                        <div class="product-widget product-filter-widget text-end">
                ...
                <div class="product-filter-right-column col-lg-9 col-md-8 col-12">
                    <div class="row dark-contnt product_filter">
    ...
    <section class="home-product-extra  padding-bottom">
        <div class="container">
            ...
            <div class="product-extra-slider dark-contnt">
                @foreach ($bestSeller as $all_product)
                @php
