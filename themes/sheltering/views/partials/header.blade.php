            ...
            <div class="navigationbar-row d-flex align-items-center">
                <div class="menu-items-col">
                    <div class="logo-col mobile-only">
                        <h1>
                            <a href="{{route('landing_page',$slug)}}">
                                <img src="{{isset($theme_logo) && !empty($theme_logo) ? $theme_logo : 'themes/'.APP_THEME().'/assets/images/logo.png'}}" alt="Logo">
                            </a>
                        </h1>
                    </div>
                    <ul class="main-nav">
                    ...
                    <ul class="menu-right">
                        @auth
                            <ul class="main-nav">
                                <li class="menu-lnk has-item" style="margin-left: 277px;">
                                    <a href="#" >
                                    ...
                                    <div class="menu-dropdown ">
                                        <ul>
                                            <li>
                                                <a href="{{ route('my-account.index',$slug) }}" style="margin-left: 17px; width: fit-content; background-color: transparent;">{{ __('My Account') }}</a>
                                            </li>
                                            <li>
                                                <form method="POST" action="{{ route('logout_user',$slug) }}" id="form_logout">
                                                    @csrf
                                                    <a href="#" onclick="event.preventDefault(); this.closest('form').submit();" style="margin-top: -53px;background-color: transparent; width: fit-content;" class="dropdown-item">
                                                        {{ __('Log Out') }}
                                                    </a>
                                                </form>
                                            </li>
                        ...
                        <li class="whislist-header">
                            <a href="javascript:;" title="wish" class="wish-header">
                                ...
                                {{-- <span class="count wishlist-counter">12</span> --}}
                            </a>
                        </li>
                        @endauth
