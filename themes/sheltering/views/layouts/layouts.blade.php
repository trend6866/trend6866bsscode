...
$metaimage = \App\Models\Utility::GetValueByName('metaimage', $theme_name);
    ...
    $title = \App\Models\Utility::GetValueByName('theme_name',$theme_name) ? \App\Models\Utility::GetValueByName('theme_name',$theme_name) : 'Camping Theme Workdo';
...
<head>
    ...
    <meta name="author" content="Camping Theme. Workdo">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />
    <title>@yield('page-title') - {{ $title }}  </title>
    <meta name="base-url" content="{{URL::to('/')}}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="Camping Theme. Workdo">
    <meta name="keywords" content="Camping Theme. Workdo">
